	...
	function configExt(array $PublicConf, $type = 'prod'){
		$config = [
			'prod' => [
				...
				'return_url' => 'http://' . $PublicConf['f_url'].'/fabi_ipaylive/payReturn.php',	//页面跳转同步通知页面路径
				'notify_url' => 'http://' . $PublicConf['f_url'].'/fabi_ipaylive/payNotify.php',	//服务器异步通知页面路径
				'inquiry_url' => 'http://' . $PublicConf['f_url'].'/fabi_ipaylive/order_inquiry.php',
				//'qrimg_url' => 'http://' . $PublicConf['f_url'].'/ipaylive/QRImg.php',	//服务器异步通知页面路径
				'input_charset' => 'UTF-8',					//字符编码格式 目前支持 utf-8
				'request_gateway' => 'http://202.146.216.16:9487/api/request'
			]
		];
