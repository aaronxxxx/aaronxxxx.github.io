            ...
            <div class="span10 offset1">
                ...
                <div class="low-half-radius-border" style="padding-top: 10px;">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls" style="margin-left: 110px; padding-top: 5px;">
                            <span><input type="text" id='totalAmount' name="totalAmount" style="width: 50px;;">最低充值<?php echo  $configdata['money_Lowest'] ;?>元。</span>
                        </div>
                    </div>。
                </div>
            </div>
        ...
        <div class="row-fluid">
            <div class="span10 offset1">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active">
                        <a href="javascript:void(0);"  onclick="show_bank(this)" name="GATEWAY" class="gray_color" onmouseover="this.style.cursor='pointer'"><strong>网关支付</strong></a>
                    </li> 
                ...
                <div style="border-left: 1px solid #ddd; border-right: 1px solid #ddd; border-bottom: 1px solid #ddd; margin-top: -20px;">
                    <div class="container-fluid" style="padding-top:20px;">
                        ...
                        <div class="row-fluid" style="padding-left: 20px; margin-bottom: 10px; display: none" id="GATEWAY">
							<?php
						...
						<div class="row-fluid" style="padding-left: 20px; margin-bottom: 10px; display: none" id="WAP">
                            <?php
								if(count($configext['type'] > 0)){
									foreach($configext['type'] as $key1 => $value1){
