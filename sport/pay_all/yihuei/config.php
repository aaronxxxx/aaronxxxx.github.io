	...
	function configExt(array $PublicConf, $type = 'prod'){
		$config = [
			'prod' => [
				...
				'return_url' => 'http://' . $PublicConf['f_url'].'/yihuei/payReturn.php',	//页面跳转同步通知页面路径
				'notify_url' => 'http://' . $PublicConf['f_url'].'/yihuei/payNotify.php',	//服务器异步通知页面路径
				'inquiry_url' => 'http://' . $PublicConf['f_url'].'/yihuei/order_inquiry.php',	//服务器异步通知页面路径
				'input_charset' => 'UTF-8',					//字符编码格式 目前支持 utf-8
				'request_gateway' => 'https://pay.e100pay.com/api/gateway/payment',			//API URL
				'Appid' => '50032e6820a8430f88dba9af00a48f1c',
			]
		];
			...
			'bankCode' => [
				...
				*/
				...
				'WCKPAY' => [
					'img' => 'radio-img-quick',
					'name' => '快捷支付',
					'value' => 'quick_unionpay',
				],*/
				'90' => [
					'img' => 'radio-img-netbank',
					'name' => '網銀支付',
					'value' => 'bank_unionpay'
				],				
			],
