	...
	function configExt(array $PublicConf, $type = 'prod'){
		$config = [
			'prod' => [
				...
				'return_url' => 'http://' . $PublicConf['f_url'].'/ipaylive/payReturn.php',	//页面跳转同步通知页面路径
				'notify_url' => 'http://' . $PublicConf['f_url'].'/ipaylive/payNotify.php',	//服务器异步通知页面路径
				'inquiry_url' => 'http://' . $PublicConf['f_url'].'/ipaylive/order_inquiry.php',
