            ...
            <div class="span10 offset1">
                ...
                <div class="low-half-radius-border" style="padding-top: 10px;">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls" style="margin-left: 110px; padding-top: 5px;">
                            <span><input type="text" id='totalAmount' name="totalAmount" style="width: 50px;;">最多支持小数点两位金额；单笔<?php echo  $configdata['money_Lowest'];?>~<?php echo  $configdata['money_limits'];?>元。</span>
                        </div>
                    </div>。
                </div>
            </div>
...
<script type="text/javascript">
	...
	function check_suc(obj){
		...
		if (money < <?php echo  $configdata['money_Lowest'] ;?>){
			alert("单笔充值最小金额"+<?php echo  $configdata['money_Lowest']?>+"元！");return false;
		}
