	...
	function configExt(array $PublicConf, $type = 'prod'){
		$config = [
			'prod' => [
				...
				'return_url' => 'http://' . $PublicConf['f_url'].'/sfgpay/payReturn.php',	//页面跳转同步通知页面路径
				'notify_url' => 'http://' . $PublicConf['f_url'].'/sfgpay/payNotify.php',	//服务器异步通知页面路径
				'inquiry_url' => 'http://' . $PublicConf['f_url'].'/sfgpay/order_inquiry.php',
				'qrimg_url' => 'http://' . $PublicConf['f_url'].'/sfgpay/QRImg.php',	//服务器异步通知页面路径
				'input_charset' => 'UTF-8',					//字符编码格式 目前支持 utf-8
				'request_gateway' => 'http://47.75.187.107/api/pay/getQrPms'			//API URL
			]
		];
