...
foreach ($player as $key => $val) {
    ?>
                                <tr class="title_line" id="here<?=$val['id']?>">
                                    ...
                                    <td class="odds">
                                        <input type="number" name="<?=$val['id']?>-player_score" id="<?=$val['id']?>-player_score" value="<?php if (isset($postData[$val['id'] . '-player_score'])) {
        echo $postData[$val['id'] . '-player_score'];
    }
...
foreach ($multiple[$key]['items'] as $key2 => $val2) {
        ?>
                                <tr class="title_line">
                                    ...
                                    <td>
                                        <input type="radio" name='<?=$val['id']?>-multiple' value="<?=$val2['id']?>" value="<?php if (isset($postData[$val['id'] . '-multiple'])) {
            echo 'selected';
        }
        ?>" required>
                                    </td>
...
<div id="chartReport">
    ...
    <div id="pk-bar-chart" style="position: relative; height: 300px;">
    </div>
