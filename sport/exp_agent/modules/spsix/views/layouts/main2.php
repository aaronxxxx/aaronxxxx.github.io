...
<div>
    ...
    <div class="navleft">
        <table width="173" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <td>
                                    <table id="submenu3" cellspacing="0" cellpadding="0" width="100%" border="0" class="tabpd">
                                        ...
                                        <tr>
                                            <td><img src="/public/common/images/closed.gif" /></td>
                                            <td height="23"><a
                                                    href="Lottery/config/lottery_spsix_config.php" target="main">彩票金额设置</a></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td  class="tdbg">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td width="35"></td>
                                            <td  class="titledaohang" style="cursor: hand" onClick="showsubmenu(4);"><span class="styles">极速六合彩管理</span></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <table id="submenu4" cellspacing="0" cellpadding="0" width="100%" border="0" class="tabpd">
                                        ...
                                        <tr>
                                            <td width="2%"><img src="/public/common/images/closed.gif" /></td>
                                            <td height="23"><a href="/?r=six/index/index">极速六合彩注单(按用户)</a></td>
                                        </tr>
                                        <tr>
                                            <td width="2%"><img src="/public/common/images/closed.gif" /></td>
                                            <td height="23"><a href="/?r=six/index/order">极速六合彩注单(按注单)</a></td>
                                        </tr>
                                        ...
                                        if (isset(Yii::$app->params['U_Purview']) && strpos(Yii::$app->params['U_Purview'], '修改彩票赔率')) {
                                            ...
                                            <tr>
                                                <td width="2%"><img src="/public/common/images/closed.gif" /></td>
                                                <td height="23"><a href="/?r=six/odds/liangmian">极速六合彩赔率</a></td>
                                            </tr>
                                        <?php } ?>
                                        <tr>
                                            <td width="2%"><img src="/public/common/images/closed.gif" /></td>
                                            <td height="23"><a href="/?r=six/index/result">极速六合彩开奖结果</a></td>
                                        </tr>
                                        <tr>
                                            <td width="2%"><img src="/public/common/images/closed.gif" /></td>
                                            <td height="23"><a href="/?r=six/index/qishu" >极速六合彩期数设置</a></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </td>
            ...
            <?php
            if (isset(Yii::$app->params['U_Purview']) && strpos(Yii::$app->params['U_Purview'], '编辑体育赛事') && false) {//先注释了
                ?>
                ...
                <tr>
                    <td>
                        <table class=leftframetable cellSpacing=0 cellPadding=0 width="100%" align=right border=0>
                            ...
                            <tr>
                                <td  class="tdbg">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td width="35"></td>
                                            <td class="styles" style="cursor: hand" onclick=showsubmenu(11); height=25>赛事管理</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <table id=submenu11 cellSpacing=0 cellPadding=0 width="100%" border=0 class="tabpd">
                                        <tbody>
                                        <tr>
                                            <td width="2%"><img src="/public/common/images/closed.gif"></td>
                            ...
                            <tr>
                                <td>
                                    <table id=submenu10 cellSpacing=0 cellPadding=0 width="100%" border=0 class="tabpd">
                                        ...
                                        <tr>
                                            <td width="2%"><img src="/public/common/images/closed.gif"></td>
                                            <td height=23><a href="report/spsix_lottery_history.php" target="main">极速六合彩明细</a>┆<a href="report/spsix_lottery_sp.php" target="main">极速六合彩-特码</a></td>
                                        </tr>
                                        <tr>
                                            <td width="2%"><img src="/public/common/images/closed.gif"></td>
