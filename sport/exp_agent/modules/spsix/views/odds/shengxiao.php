            ...
            <div id="content_inner">
                ...
                <div>
                    <div id="wager_groups" class="CQ">
                        ...
                        <a href="#/six/odds/sheng-xiao" title="生肖" class="NowPlay">生肖</a>
                    ...
                    foreach ($data as $key => $val) {
                        if($key!='NX'){?>
                            <div id="<?=$key?>" style="display:<?php echo $key!='SPA' ? 'none':"";?>"  class="showT">
                                <form action="/?r=six/odds/sheng-xiao" method="post" name="<?=$key?>">
                                    ...
                                    <div id="SendB5">
                                        ...
                                        <button id="btn-save-odds" class="order" type="<?=$key;?>" data-herf="#/six/odds/sheng-xiao">保存</button>
                                    </div>
                                </form>
                            </div>
                        <?php }else{?>
