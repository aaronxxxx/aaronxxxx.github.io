                    ...
                    <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="font12" bgcolor="#798EB9">
                        ...
                        <?if($group!=''){?>
                            <tr>
                                <td bgcolor="#FFFFFF" align="left">
                                    <a href="/?r=six/statement/six-detail" style="color: #F37605;" title="返回上一页">返回上一页</a>
                                </td>
                            </tr>
                        <? }?>
                        <tr>
                        ...
                        <tr>
                            <td align="left" bgcolor="#FFFFFF">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="hidden" name="r" value="six/statement/six-detail">
                        ...
                        <tr align="center" style="background-color:#FFFFFF; line-height:20px;">
                            <?php if($group==''){?>
                                <td height="25" align="center" valign="middle">
                                    <a title="极速六合彩" style="color: #F37605;" href="/?r=six/statement/six-detail&s_time=<?=$startTime;?>&e_time=<?=$endTime;?>&user_in=<?=$userIn;?>&user_nin=<?=$userNin;?>&date_month=<?=$month;?>&group=user">极速六合彩</a>
                                </td>
                            <?php }?>
                            <?php if($group=='user'){?>
                                <td height="25" align="center" valign="middle">极速六合彩</td>
                                <td align="center" valign="middle"><a title="极速六合彩" style="color: #F37605;" href="/?r=six/statement/six-detail&s_time=<?=$startTime;?>&e_time=<?=$endTime;?>&user_in=<?=$userIn;?>&user_nin=<?=$userNin;?>&date_month=<?=$month;?>&group=num&user=<?=$val['user_name'];?>"><?=$val['user_name'];?></a>(<?=$val['pay_name']?>)</td>
                            <?php } ?>
                            <?php if($group=='num'){?>
