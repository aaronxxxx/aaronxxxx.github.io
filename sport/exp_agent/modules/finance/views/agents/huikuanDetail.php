<form name="form1" id="form1" method="post" action="?r=finance/agents/do-huikuan">
            ...
            <td  valign="top" >
                ...
                <table width="100%" border="1"  cellspacing="0" cellpadding="0" class="font14 skintable line35" id=editProduct   width="100%" >
                    ...
                    <tr align="center">
                        ...
                        <td width="78%" align="left"><?= $data["agents_name"] ?></td>
                    </tr>
                    <tr align="center">
                    ...
                    <?php if ($update) { ?>
                        ...
                        <tr align="center" class="trinput inputct huikuanmange">
                            <td colspan="2" align="center">
                                <?php
                                if ($data['status'] == '未結算' && !in_array($data["agents_name"], $hacker_list)) {
                                    ?>
                                    ...
                                    if (in_array($data["agents_name"], $hacker_list)) {
                                ...
                                ?>
                                <input type="button" name="Submit" value="返回" onClick="javascript:window.location.href = '?r=finance/agents/huikuan&t=' + new Date().getTime();">
...
<script>
    function check($v) {
        ...
        layer.confirm(a, {btn: ['確定', '取消']}, function () {
            ...
            $.ajax({
                type: "POST",
                url: '/?r=finance/agents/do-huikuan',
                ...
                success: function (data) {
                    layer.alert(data, function (index) {
                        layer.closeAll();
                        window.location.href = '?r=finance/agents/huikuan-detail&id=' + id + '&update=1&t=' + new Date().getTime();
                    })
                }
            })
        })
