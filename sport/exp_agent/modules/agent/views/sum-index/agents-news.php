<html>
    ...
    <body>
        <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
            <tbody>
                <tr>
                    <td height="24" nowrap=""><font>&nbsp;<span class="STYLE2">代理管理：編輯代理信息</span></font></td>
                </tr>
                <tr>
                        ...
                        <form class="trinput font14 "  method="post" name="form1" id="form1">
                            <div class="trinput font15 addgents ">
                                ...
                                <div class="item">
                                    ...
                                    <span class="ji">~</span><input type="text" name="total_1_2" id='total_1_2' value="<?= $agents_list['total_1_2'] ?>" size="10">
                                ...
                                <div class="item">
                                    ...
                                    <input type="text" name="total_2_1" id='total_2_1' value="<?= $agents_list['total_2_1'] ?>" size="10">
                                    <span class="ji">~</span><input type="text" name="total_2_2" id='total_2_2' value="<?= $agents_list['total_2_2'] ?>" size="10">
                                ...
                                <div class="item">
                                    ...
                                    <input type="text" name="total_3_1"id='total_3_1' value="<?= $agents_list['total_3_1'] ?>" size="10">
                                    <span class="ji">~</span><input type="text" name="total_3_2"id='total_3_2' value="<?= $agents_list['total_3_2'] ?>" size="10">
                                ...
                                <div class="item">
                                    ...
                                    <input type="text" name="total_4_1" id='total_4_1' value="<?= $agents_list['total_4_1'] ?>" size="10">
                                    <span class="ji">~</span><input type="text" name="total_4_2"id='total_4_2' value="<?= $agents_list['total_4_2'] ?>" size="10">
                                ...
                                <div class="item">
                                    ...
                                    <span class="gs">業績等級5結算比例(百分比):</span><input type="text" name="total_5_scale"id='total_5_scale' value="<?= $agents_list['total_5_scale'] ?>" size="10">
                                </div>
                                <!--
                                <div class="item">
                                ...
                                <div class="item  agenbtnct">
                                    <div class="ct">
                                        ...
                                        <input type="button" value="返 回" onclick="location.href='?r=agent/sum-index/list'">
                                    </div>
                                </div>
                            </div>
                        </form>
