...
<body>
    ...
    <div id="pageMain">
        <div class="pd10">
            <form class="trinput font14 " name="gridSearchForm" id="gridSearchForm" method="get" action="?r=agent/cqk/child-list" onsubmit="return check();">
        ...
        <table width="100%" border="1" bgcolor="#FFFFFF" class="font13n dailis skintable" id="editProduct" idth="100%">       
            <tbody>
                <tr  class="t-title dailitr" align="center">
                    <td style="width: 13%" align="center"><strong>代理用戶名</strong></td>
                    <td style="width: 13%" align="center" height="25"><strong>下屬會員名</strong></td>
                    <td style="width: 13%" align="center"><strong>匯款金額</strong></td>
                    <td style="width: 13%" align="center"><strong>存款金額(排除活動金額)</strong></td>
                    <td style="width: 12%" align="center"><strong>取款金額(排除活動金額)</strong></td>
                    <td style="width: 12%" align="center"><strong>合計盈利(排除活動金額)</strong></td>
                    <td style="width: 12%" align="center"><strong>後台加錢(用於活動)</strong></td>
                    <td style="width: 12%" align="center"><strong>後台扣錢(用於活動)</strong></td>
                </tr>
                <?php
                if ($user_list) {
