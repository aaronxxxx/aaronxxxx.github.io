...
<!--                                <div class ="item"> -->
<!--                                    <span class="name">PK10退水比例(0.009=0.9%)</span> -->
<!--                                    <input type="text" name="PK10_return_water" id="PK10_return_water" value="--><?//= $agents_list['PK10_return_water'] ?><!--" size="10"> -->
<!--                                </div>-->
                                <!-- <div class="item">
                                ...
                                <div class="item  agenbtnct">
                                    <div class="ct">
                                        ...
                                        <input type="button" value="返 回" onclick="location.href='/?r=agent/index/list'">
                                    </div>
                                </div>
                            </div>
                        </form>
