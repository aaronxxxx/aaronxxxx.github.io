...
<div class="pro_title pd10">
    ...
    <div id="pageMain">
        <form class="trinput font14 " name="gridSearchForm" id="gridSearchForm" method="get" action="?r=agent/report/index" >
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            總代理：<input name="agent_level" value="<?= $agent_level; ?>" type="text" style="width: 100px;" readonly="readonly"> (上級代理ID,0為全部列出)
                    ...
                    foreach ($agents_list as $key => $value) {
                        ...
                        <tr align="center" onmouseover="this.style.backgroundColor =' #EBEBEB'" onmouseout="this.style.backgroundColor =' #ffffff'" style="line-height: 20px; background-color: rgb(255, 255, 255);">
                            <td height="40" align="center" valign="middle">
                                <a style="color: #F37605;" href="?r=agent/report/one-agent&id=<?= $value['id'] ?>&s_time=<?= urlencode($time['s_time']) ?>&e_time=<?= urlencode($time['e_time']) ?>"><?= $value['agents_name'] ?></a>
                            </td>
