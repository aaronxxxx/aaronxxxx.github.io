...
<div class="pro_title pd10">
    ...
    <div id="pageMain">
        <form class="trinput font14 " name="gridSearchForm" id="gridSearchForm" method="get" action="?r=agent/report/sum-index" >
                    ...
                    foreach ($agents_list as $key => $value) {
                        ...
                        <tr align="center" onmouseover="this.style.backgroundColor =' #EBEBEB'" onmouseout="this.style.backgroundColor =' #ffffff'" style="line-height: 20px; background-color: rgb(255, 255, 255);">
                            <td height="40" align="center" valign="middle">
                                <a style="color: #F37605;" href="?r=agent/report/index&agent_level=<?= $value['id'] ?>&s_time=<?= urlencode($time['s_time']) ?>&e_time=<?= urlencode($time['e_time']) ?>"><?= $value['agents_name'] ?></a>
                            </td>
