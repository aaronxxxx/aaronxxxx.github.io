 ...
 */
class EgameController extends BaseController
{
	/**
	 * 初始化处理方法
	 */
    ...
    public function actionIndex()
    {
		...
		// 获取总记录数及聚合信息
		$sumrs=LiveOrder::getEgameOrderCount($userstr,$gametype,$start_order_time,$end_order_time);
		$pagination = new Pagination(['totalCount' => $sumrs["count"],'pageSize'=>50]);
		$rs=LiveOrder::getEgameOrder($userstr,$gametype,$start_order_time,$end_order_time,$pagination->offset,$pagination->limit);
