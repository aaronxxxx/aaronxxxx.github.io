...
/**
 * 六合彩表订单操作
 * SixLotteryOrder is the model behind the spsix_lottery_order.
 */
class SpsixLotteryOrder extends ActiveRecord {
    ...
    static public function getOrderDelailSpSix($arr_id){
...
//            ->createCommand()->getrawSql();return $list;
    ...
    * @$group     分组字段
     * @$user      查询的用户
    */
    public static function spsixDetail($startTime,$endTime,$userIn,$userNin,$group,$user){
        $list = array();
        $list = SpsixLotteryOrder::find()
