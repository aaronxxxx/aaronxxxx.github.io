        ...
        <tr>
            <td height="24">
                ...
                <span class="pro_title">
                    代理管理：下属会员 <?php echo $all['user_name'] ?> 六合彩报表信息
                </span>
                </font>
                ...
                <tr>
                    <td valign="top">
                        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="font12" bgcolor="#798EB9">
                            <form name="select_form" id="select_form" method="get" action="/?r=agentht/six/index" onsubmit="return check();">
                                <input type="hidden" name="r" value="agentht/six/index">
