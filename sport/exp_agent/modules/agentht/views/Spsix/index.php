        ...
        <tr>
            <td height="24">
                ...
                <span class="pro_title">
                    代理管理：下属会员 <?php echo $all['user_name'] ?> 极速六合彩报表信息
                </span>
                </font>
                ...
                <tr>
                    <td valign="top">
                        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="font12" bgcolor="#798EB9">
                            <form name="select_form" id="select_form" method="get" action="/?r=agentht/spsix/index" onsubmit="return check();">
                                <input type="hidden" name="r" value="agentht/spsix/index">
                        ...
                        <table width="100%" border="1" bgcolor="#FFFFFF" bordercolor="#96B697" cellspacing="0" cellpadding="0"  class="font13 skintable line35 mgt10" id=editProduct >
                            <tbody>
                                ...
                                <?php
                                if ($spsix_list) {
                                    foreach ($spsix_list as $key => $value) {
                                        ?>
                                        <tr align="center" style="background-color:#FFFFFF; line-height:20px;">
                                            <td align="center" valign="middle"  height="25"><?php echo $value['order_sub_num']; ?></td>
                                            ...
                                            <td align="center" valign="middle"><?php echo $value['number']; ?></td>
