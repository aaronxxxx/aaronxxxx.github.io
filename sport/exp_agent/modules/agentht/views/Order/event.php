...
<div id="pageMain" style="margin-top: 20px;">
    <form name="form1" method="get" id="gridSearchForm" action="/?r=agentht/order/event" id="form1">
        <input type="hidden" name="r" value="agentht/order/event">
    ...
    <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12 skintable line35">
        ...
        if($list){
            foreach ($list as $key=>$val){?>
                <tr align="center">
                    <td height="25" align="center" valign="middle"><?=$val['order_num'];?></td>
                    <td align="center" valign="middle">賽事</td>
                    <td align="center" valign="middle"><?=$val['qishu'];?></td>
                    <td align="center" valign="middle" style="max-width:115px"><?= $gameType[$val['game_type']]; ?></td>
