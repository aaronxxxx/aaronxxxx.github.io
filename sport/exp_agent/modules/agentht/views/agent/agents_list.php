...
?>
<body>
    <table width="100%" border="0" cellspacing="0" cellpadding="5" class="mgt10">
        <tr>
            <td height="24">
                <font>
               <span class="pro_title">
                ...
                <a href="/?r=agentht/agent/agents-list&Oid=1" style="font-size: 13px;margin-left: 50px;color: #f34541">查询在线下属会员信息</a>
            </td>
        </tr>
    </table>
                ...
                <tr>
                    <td valign="top">
                        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                            <form name="select_form" id="select_form" method="get" action="/?r=agentht/agent/agents-list" onsubmit="return check();" >
                                <input type="hidden" name="r" value="agentht/agent/agents-list">
                                <tbody>
                                    <tr class="trinput font14 mgb10 inputct">
                                        <td >
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="?r=agentht/agent/agents-list2">下属会员详细信息</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </form>
                        ...
                        <br>
                        <table width="100%" cellspacing="0" cellpadding="0"  id=editProduct  class="font13 skintable line35">
                            <tbody>
                                <tr>
                                    ...
                                    foreach ($user_list as $key => $value) {
                                        ...
                                        <tr align="center" onmouseover="this.style.backgroundColor ='#EBEBEB'" onmouseout="this.style.backgroundColor ='#ffffff'" style="line-height: 20px; background-color: rgb(255, 255, 255);">
                                            <td height="40" align="center" valign="middle">
                                                <a style="color: #F37605;" href="?r=agentht/agent/report-type&user_name=<?= $value['user_name']?>&s_time=<?php echo $time['s_time'] ?>&e_time=<?php echo $time['e_time'] ?>&user_id=<?php echo $value['user_id'] ?>"><?php echo $value['user_name'] ?></a>
                                            </td>
                                ...
                                <tr>
                                    ...
                                    <!-- <td style="width: 13%" align="center"><strong><?=$sumTotal['live_bet_money']?>/<?=$sumTotal['live_win']?></strong></td> -->
                                    <!-- <td style="width: 13%" align="center"><strong><?=$sumTotal['lottery_bet_money']?>/<?=$sumTotal['lottery_win']?></strong></td> -->
                                    <!-- <td style="width: 13%" align="center"><strong><?=$sumTotal['six_bet_money']?>/<?=$sumTotal['six_win']?></strong></td> -->
                                    <!-- <td style="width: 13%" align="center"><strong><?=$sumTotal['spsix_bet_money']?>/<?=$sumTotal['spsix_win']?></strong></td> -->
                                    <td style="width: 13%" align="center"><strong><?=$sumTotal['event_bet_money']?>/<?=$sumTotal['event_win']?></strong></td>
                                    <td style="width: 17%" align="center"><strong><?=$sumTotal['bet_money']?>/<?=$sumTotal['win_money']?></strong></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
