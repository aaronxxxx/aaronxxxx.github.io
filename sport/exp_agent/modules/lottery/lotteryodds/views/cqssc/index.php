...
<script>
    $().ready(function(){
        $lottery_type = '重庆时时彩';
        $sub_type = '两面';
        $url = '/?r=lotteryodds/cqssc/up-liangmian';
        liangmian();
    })
    function liangmian(){
        $('#table').load('/?r=lotteryodds/cqssc/liangmian',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    function yizidingwei(){
        $('#table').load('/?r=lotteryodds/cqssc/yizidingwei',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    function longhuhe(){
        $('#table').load('/?r=lotteryodds/cqssc/longhuhe',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    function baozishunzi(){
        $('#table').load('/?r=lotteryodds/cqssc/baozishunzi',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    function niuniu(){
        $('#table').load('/?r=lotteryodds/cqssc/niuniu',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    $(function(){
        ...
        $('#yizidingwei_wan,#yizidingwei').click(function(){
            ...
            $sub_type = '万定位';
            $url = '/?r=lotteryodds/cqssc/up-yizidingwei';
            yizidingwei();
        })
        ...
        $('#save_odds').click(function(){
            ...
            $.ajax({
                ...
                success: function(data){
                   layer.alert(data);
                   window.location.href="#/lotteryodds/cqssc/index&"+(new Date().valueOf())+"";
                }
            });
            return false;
        })
...
<div id="box_range">
    <div id="main">
        <div id="content">
        <h2><b></b><span class=" white">重庆时时彩-赔率设置</span></h2>
