...
<script>
    $().ready(function(){
        $lottery_type = '广东十分彩';
        $sub_type = '单面双码';
        $url = '/?r=lotteryodds/gdsf/updanma';
        danma();
    })
    function danma(){
        $('#table').load('/?r=lotteryodds/gdsf/danma',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        })
    }
    function fangwei(){
        $('#table').load('/?r=lotteryodds/gdsf/fangwei',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        })
    }
    function zonghe(){
        $('#table').load('/?r=lotteryodds/gdsf/zonghe',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        })
    }
    $(function(){
        ...
        $('#fangwei').click(function(){
            $('.tab_type').hide();
            $sub_type = '方位中发白';
            $url = '/?r=lotteryodds/gdsf/upfangwei';
            fangwei();
        })
        $('#zonghe').click(function(){
            $('.tab_type').hide();
            $sub_type = '总和龙虎';
            $url = '/?r=lotteryodds/gdsf/upzonghe';
            zonghe();
        })
        $('#save_odds').click(function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    layer.alert(data);
                    window.location.href="#/lotteryodds/gdsf/index&"+(new Date().valueOf())+"";
                }
            });
            return false;
        })
    ...
    <div id="box_range">
        <div id="main">
          <div class="main-inner">
            <div id="content">
            <h2><b></b><span>广东十分彩-赔率设置</span></h2>
