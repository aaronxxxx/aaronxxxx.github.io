...
<script>
    $().ready(function(){
        $lottery_type = '排列三';
        $sub_type = '两面';
        $url = '/?r=lotteryodds/pl3/up-liangmian';
        liangmian();
    })
    function liangmian(){
        $('#table').load('/?r=lotteryodds/pl3/liangmian',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    function yizi_bai(){
        $('#table').load('/?r=lotteryodds/pl3/yizi-bai',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    function yizi_shi(){
        $('#table').load('/?r=lotteryodds/pl3/yizi-shi',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    function yizi_ge(){
        $('#table').load('/?r=lotteryodds/pl3/yizi-ge',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    function kuadu(){
        $('#table').load('/?r=lotteryodds/pl3/kuadu',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    function longhuhe(){
        $('#table').load('/?r=lotteryodds/pl3/longhuhe',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    function baozi(){
        $('#table').load('/?r=lotteryodds/pl3/baozi',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    $(function(){
        ...
        $('#longhu').click(function(){
            $('.tab_type').hide();
            $sub_type = '总和龙虎和';
            $url = '/?r=lotteryodds/pl3/up-longhuhe';
            longhuhe();
        })
        $('#sanlian').click(function(){
            $('.tab_type').hide();
            $sub_type = '3连';
            $url = '/?r=lotteryodds/pl3/up-baozi';
            baozi();
        })
        $('#save_odds').click(function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    layer.alert(data);
                    window.location.href="#/lotteryodds/pl3/index&"+(new Date().valueOf())+"";
                }
            });
            return false;
        })
...
<div id="box_body" class="bg2yellow">
    <div id="box_range">
        <div id="main">
            <div id="content">
            <h2><b></b><span class=" white">排列三-赔率设置</span></h2>
                ...
                <div id="arrowLeft"></div>
                  <div id="select_tab">
                      <div class="tab_type yizi" style="display: none;">
                          <ul>
                              <!--<li class="unTagClick onTagClick" id="yizi_qiansan"><span class="501"><b>组合</b></span></li>-->
