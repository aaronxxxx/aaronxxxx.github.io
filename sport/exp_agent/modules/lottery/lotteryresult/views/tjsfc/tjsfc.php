...
<form name="form1" id="form1" method="post" action="?r=lotteryresult/tjsfc/operation&id=<?=$id?>&action=<?=$id>0 ? 'edit' : 'add'?>&s_time=<?=$query_time?>&qishu_query=<?=$qishu_query?>">
    <div class=" trinput resulttable zudan tabft13 spanmg0">
<p>
    <span>彩票类别：</span>
    <span><strong>天津十分彩</strong></span>
</p>
<p>
    <span>开奖期号：</span>
...
<p>
   <span><input type="button" class="form_ajax_submit_btn mgl61" data-targetid="form1" data-redirect="#/lotteryresult/tjsfc/list&status=0&type=type=天津十分彩&<?=time()?>" name="submit" value="确认发布"></span>
</p>
</div>
</form>

<form name="form2" onSubmit="return queryLottery();" id="gridSearchForm" method="get" action="#/lotteryresult/tjsfc/list">
     ...
     <div class="tabft13 trinput resulttable zudan pd10">
        ...
        <div align="left">
          开奖期号：
            ...
            &nbsp;&nbsp;日期：
            <input name="s_time" type="text" id="s_time" class="date_day"  value="<?php if(isset($_GET['s_time'])){echo $_GET['s_time'];}  ?>" size="10" maxlength="10" placeholder="日期不为空" readonly="readonly" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<table width="100%" border="0" cellpadding="5" cellspacing="1"  class="font12 skintable line35">
    ...
    <tr align="center" onMouseOver="this.style.backgroundColor='#EBEBEB'" onMouseOut="this.style.backgroundColor='#fff'" style="background-color:rgb(255, 255, 255); line-height:20px;">
        <td height="25" align="center" valign="middle">天津十分彩</td>
        <td align="center" valign="middle"><?=$val['qishu']?></td>
        <td align="center" valign="middle"><?=$val['datetime']?></td>
        <td align="center" valign="middle"><img src="/public/lottery/images/ball_tjsfc/<?=BuLing($val['ball_1'])?>.png"></td>
        <td align="center" valign="middle"><img src="/public/lottery/images/ball_tjsfc/<?=BuLing($val['ball_2'])?>.png"></td>
        <td align="center" valign="middle"><img src="/public/lottery/images/ball_tjsfc/<?=BuLing($val['ball_3'])?>.png"></td>
        <td align="center" valign="middle"><img src="/public/lottery/images/ball_tjsfc/<?=BuLing($val['ball_4'])?>.png"></td>
        <td align="center" valign="middle"><img src="/public/lottery/images/ball_tjsfc/<?=BuLing($val['ball_5'])?>.png"></td>
        <td align="center" valign="middle"><img src="/public/lottery/images/ball_tjsfc/<?=BuLing($val['ball_6'])?>.png"></td>
        <td align="center" valign="middle"><img src="/public/lottery/images/ball_tjsfc/<?=BuLing($val['ball_7'])?>.png"></td>
        <td align="center" valign="middle"><img src="/public/lottery/images/ball_tjsfc/<?=BuLing($val['ball_8'])?>.png"></td>
        ...
        <td>
            <a href="#/lotteryresult/tjsfc/edit&id=<?=$val['id']?>&qishu=<?= $val['qishu']?>" >编辑</a>
            ...
            $('.js_type').click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if(data=='0'){
                            alert('结算成功');
                            window.location.href='#/lotteryresult/tjsfc/list&status=0&type=天津十分彩&n_time=<?=time();?>';
                        }else if(data == '-1'){
                            ...
                            alert('注单不存在');
                            window.location.href='#/lotteryresult/index/tjsfc&status=0&type=天津十分彩&n_time=<?=time();?>';
                        }else if(data == '9'){
                            alert('正在结算');
                            return false;
                        }
