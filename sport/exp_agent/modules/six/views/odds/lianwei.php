            ...
            <div id="content_inner">
                ...
                <div>
                    <div id="wager_groups" class="CQ">
                        ...
                        <a href="#/six/odds/lian-wei" title="连尾" class="NowPlay">连尾</a>
                ...
                <?php if($data) {
                    foreach ($data as $key => $val) { ?>
                        <div id="<?=$key?>" style="display:<?php echo $key!='LF2' ? 'none':"";?>" class="showT">
                            <form action="/?r=six/odds/lian-wei" method="post" name="<?=$key?>">
                                ...
                                <div id="SendB5">
                                    ...
                                    <button id="btn-save-odds" class="order" type="<?=$key;?>" data-herf="#/six/odds/lian-wei">保存</button>
                                </div>
                            </form>
                        </div>
                    <?php }
