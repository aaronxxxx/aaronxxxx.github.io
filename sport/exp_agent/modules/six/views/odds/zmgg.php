            ...
            <div id="content_inner">
                ...
                <div>
                    <div id="wager_groups" class="CQ">
                        ...
                        <a href="#/six/odds/zmgg" title="正码过关" class="NowPlay">正码过关</a>
                ...
                <?php if($data) {
                    foreach ($data as $key => $val) { ?>
                        <div id="<?=$key?>" style="display:<?php echo $key!='NAP1' ? 'none':"";?>" class="showT">
                            <form action="/?r=six/odds/zmgg" method="post" name="<?=$key?>">
                                ...
                                <div id="SendB5">
                                    ...
                                    <button id="btn-save-odds" class="order" type="<?=$key;?>" data-herf="#/six/odds/zmgg">保存</button>
                                </div>
                            </form>
                        </div>
                    <?php }
