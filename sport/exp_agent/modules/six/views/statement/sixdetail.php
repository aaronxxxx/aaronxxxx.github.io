                        ...
                        <tr align="center" style="background-color:#FFFFFF; line-height:20px;">
                            <?php if($group==''){?>
                                <td height="25" align="center" valign="middle">
                                    <a title="六合彩" style="color: #F37605;" href="/?r=six/statement/six-detail&s_time=<?=$startTime;?>&e_time=<?=$endTime;?>&user_in=<?=$userIn;?>&user_nin=<?=$userNin;?>&date_month=<?=$month;?>&group=user">六合彩</a>
                                </td>
                            <?php }?>
                            <?php if($group=='user'){?>
                                <td height="25" align="center" valign="middle">六合彩</td>
                                <td align="center" valign="middle"><a title="六合彩" style="color: #F37605;" href="/?r=six/statement/six-detail&s_time=<?=$startTime;?>&e_time=<?=$endTime;?>&user_in=<?=$userIn;?>&user_nin=<?=$userNin;?>&date_month=<?=$month;?>&group=num&user=<?=$val['user_name'];?>"><?=$val['user_name'];?></a>(<?=$val['pay_name']?>)</td>
                            <?php } ?>
                            <?php if($group=='num'){?>
