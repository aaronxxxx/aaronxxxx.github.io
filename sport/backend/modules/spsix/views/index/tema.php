<link rel="stylesheet" href="/public/spsix/css/chosen.css">
<script src="/public/spsix/js/chosen.jquery.js"></script>
<script>
$(function(){
    $("#qishu").chosen();
    $("#qishu_chosen").css("width","150px");
    
});
</script>
<div id="pageMain">
 
                <form name="gridSearchForm" id="gridSearchForm" method="get" action="#/spsix/index/tema">
                    <div class="pro_title pd10"> <span title="极速六合彩特码报表" class="pro_title">极速六合彩特码报表</span></div>
