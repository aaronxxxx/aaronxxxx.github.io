...
<div id="pageMain">
            ...
            <form name="form1" method="post" action="?r=spsix/index/update-qishu" id="form1">
                <div class="font13 trinput resulttable w736">
                    ...
                    <p>
                            <span>
                            <input type="button" class="form_ajax_submit_btn mgl61" data-targetid="form1" data-redirect="#/spsix/index/qishu&t=<?=time();?>" name="submit" value="确认发布" />
                            </span>  </p>
                  
                </div>
            </form>

            <form name="form2" method="get" id="gridSearchForm" action="#/spsix/index/qishu">
                    ...
                    if($list){
                        foreach ($list as $key=>$val){?>
                            <tr align="center" onmouseover="this.style.backgroundColor='#EBEBEB'" onmouseout="this.style.backgroundColor='#ffffff'" style="line-height: 20px; background-color: rgb(255, 255, 255);">
                                ...
                                <td>
                                    <a href="#/spsix/index/qishu&qishu=<?=$val['qishu']?>">编辑</a>
                ...
                success: function(data){
                    ...
                    layer.alert(data,function (index) {
                        ...
                        if(data=='修改成功' || data=='添加成功'){
                            location.href = '#/spsix/index/qishu';
                        }
                        layer.closeAll();
                    });
                }
    ...
    function deleteResult_lhc(id) {
        layer.confirm('确定要删除吗?',function () {
            var fsrate = prompt("请输入修改密码:", "");
                $.ajax({
                    type:'post',
                    url:'/?r=spsix/index/qishu-delete',
                    data:{id:id,
