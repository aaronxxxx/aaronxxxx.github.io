            ...
            <div id="content_inner">
                ...
                <div>
                    <div id="wager_groups" class="CQ">
                        ...
                        <a href="#/spsix/odds/lian-xiao" title="连肖"  class="NowPlay">连肖</a>
                ...
                <?php if($data) {
                    foreach ($data as $key => $val) { ?>
                        <div id="<?=$key?>" style="display:<?php echo $key!='LX2' ? 'none':"";?>" class="showT">
                            <form action="/?r=spsix/odds/lian-xiao" method="post" name="<?=$key?>">
                                ...
                                <div id="SendB5">
                                    ...
                                    <button id="btn-save-odds" class="order" type="<?=$key;?>" data-herf="#/spsix/odds/lian-xiao">保存</button>
                                </div>
                            </form>
                        </div>
                    <?php }
