...
<div id="box_body" class="bg2yellow">
    ...
    <div id="content_inner">
        ...
        <div>
            <div id="wager_groups" class="CQ">
                ...
                <a href="#/spsix/odds/tou-wei" class="NowPlay" title="头尾数">头尾数</a>
            </div>
        </div>
    </div>
    ...
    <div id="Game">
        <div id="SPA" class="showT" style="width: 120%;">
            <form id="formLhc" name="D3_018" action="/?r=spsix/odds/tou-wei" method="post">
                ...
                <div id="SendB5">
                    ...
                    <button id="btn-save-odds" class="order" data-herf="#/spsix/odds/tou-wei">保存</button>
                </div>
            </form>
        </div>
