            ...
            <div id="content_inner">
                ...
                <div>
                    <div id="wager_groups" class="CQ">
                        ...
                        <a href="#/spsix/odds/sebo" title="色波" class="NowPlay">色波</a>
                    ...
                    foreach ($data as $key => $val) {
                        if ($key == 'SP') {
                            ...
                            <div id="<?= $key ?>" class="showT">
                                <form action="/?r=spsix/odds/sebo" method="post" name="<?= $key ?>">
...
<!--                                                <td colspan="5"></td>-->
                                    ...
                                    <div id="SendB5">
                                        ...
                                        <button id="btn-save-odds" class="order" type="<?= $key; ?>"  data-herf="#/spsix/odds/sebo">保存</button>
                                    </div>
                                    <p>
...
<!--                                                <td colspan="7"></td>-->
                        ...
                        <?php } else { ?>
                            <div id="<?= $key ?>" class="showT" style="display: none;">
                                <form id="formLhc" name="<?= $key; ?>" action="/?r=spsix/odds/sebo" method="post">
                                    <div class="round-table">
                                        <table class="GameTable">
                                            <tbody>
                                            <tr class="title_line">
                                    ...
                                    <div id="SendB5">
                                        <input type="hidden" name="sub_type" value="<?= $key; ?>">
                                        <input type="hidden" name="ball_type" value="<?=$val['ball_type'];?>">
                                        <button id="btn-save-odds" class="order" data-herf="#/spsix/odds/sebo">保存</button>
                                    </div>
                                    <p>
                                    <span>请输入修改密码 : <input name="superpassword" type="password" value="" /></span>
                                    </p>
