            ...
            <div id="content_inner">
                ...
                <div>
                    <div id="wager_groups" class="CQ">
                        ...
                        <a href="#/spsix/odds/zheng-ma-te" title="正码特" class="NowPlay">正码特</a>
                ...
                <?php if($data) {
                    foreach ($data as $key => $val) {?>
                        <div id="<?=$key?>" style="display:<?php echo $key!='SP' ? 'none':"";?>" class="showT">
                            <form action="/?r=spsix/odds/zheng-ma-te" method="post" name="<?=$key?>">
                                <div class="round-table">
                                    <?php if($key=='SP'){?>
                                        <div style="margin: 2px 10px;">
                                            ...
                                            <div style="border:2px solid red;margin: 4px 0;">例如：用户投注极速六合彩600，最小反水金额为500，反水比例0.01，用户会得到反水6=600*0.01。</div>
                                        </div>
                                    <?php   }?>
                                ...
                                <div id="SendB5">
                                    ...
                                    <button id="btn-save-odds" class="order" type="<?=$key;?>" data-herf="#/spsix/odds/zheng-ma-te">保存</button>
                                </div>
                            </form>
                        </div>
                    <?php }
