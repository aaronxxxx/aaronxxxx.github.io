    ...
    <div id="box_range">
        <div id="content">
            ...
            <div id="tab" class="tab_type">
                <ul>
                    <li class="onTagClick"><span class="N1"><b><?= $data['title'] ?> : 两方比赛</b></span></li>
                </ul>
            </div>
            <div id="game">
                <form method="post" action="/?r=event/odds/twopkall">
                    <div class="round-table">
                        <table class="GameTable">
                            <tr class="title_line">
                                <td style="width:30px"><label>期数</label></td>
                                <td style="width:30px"><label>赛事名称</label></td>
                                <td style="width:30px"><label>主方赔率</label></td>
                                <td style="width:30px"><label>客方赔率</label></td>
                                <td style="width:30px"><label>调整基值</label></td>
                                <td style="width:30px"><label>启动额</label></td>
                        ...
                        ?>
                                <tr class="title_line" id="here<?= $val['id'] ?>">
                                    ...
                                    <td>
                                        <button type="button" class="order" onclick="ajaxTwopkone(<?= $val['id'] ?>)">单笔送出</button>
                                    </td>
                                </tr>
                        <?php
                            }
            ...
            <div id="tab" class="tab_type">
                <ul>
                    <li class="onTagClick"><span class="N1"><b><?= $data['title'] ?> : 多项目</b></span></li>
                </ul>
            </div>
            <div id="game">
                <form method="post" action="/?r=event/odds/multipleall">
                    <div class="round-table">
                        <table class="GameTable">
                            <tr class="title_line">
                                <td style="width:30px"><label>期数</label></td>
                                <td style="width:30px"><label>标题</label></td>
                                <td style="width:30px"><label>状态</label></td>
                                <td style="width:30px"><label>名称</label></td>
                                <td style="width:30px"><label>胜率</label></td>
                                <td style="width:30px"><label>赔率</label></td>
                                <td style="width:30px"><label>修改</label></td>
                            </tr>
                        <?php
                        ...
                        ?>
                                <tr class="title_line" id="here<?= $val['id'] ?>">
                                    ...
                                    <td>
                                        <button type="button" class="order" onclick="ajaxMultipleone(<?= $val['id'] ?>)">单笔送出</button>
                                    </td>
                                </tr>
                        <?php
                            }
