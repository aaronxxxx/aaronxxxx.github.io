...
<form class="form-horizontal" enctype="multipart/form-data" method="post" action="/?r=event/twopk/edit">
    <div class="tabft13 trinput zudan spanmg0">
        ...
        <p>
            ...
            <span>
                <select name="player1_status" id="player1_status">
                    ...
                    <option value="2" <?php if ($data['player1_status'] == 2) { echo 'selected'; } ?>>暂停下注</option>
                </select>
            </span>
        </p>
        <p>
        ...
        <p>
            ...
            <span>
                <select name="player2_status" id="player2_status">
                    <option value="1">正常下注</option>
                    <option value="2" <?php if ($data['player2_status'] == 2) { echo 'selected'; } ?>>暂停下注</option>
                </select>
            </span>
        </p>
        <p>
        ...
        <p>
            <span>调整基值：</span>
            <span>
                <input type="text" name="adj_basic" id="adj_basic" value="<?= $odds['adj_basic'] ?>" size="20" maxlength="100">&nbsp;
