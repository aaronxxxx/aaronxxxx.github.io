...
<div class="pro_title">两方比赛</div>
<button class="btn btn-sm" style="margin-bottom: 10px;" onclick="javascript:location.href='#/event/official/index'">返回赛事列表</button>
&emsp;
<button class="btn btn-sm btn-primary pull-right" style="margin-bottom: 10px;" onclick="javascript:location.href='#/event/twopk/add&oid=<?= $oid ?>'">新增资料</button>
