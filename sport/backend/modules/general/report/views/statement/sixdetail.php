                    ...
                    foreach ($data as $key => $val) {
                        ...
                        <tr align="center">
                                <td height="25" align="center" valign="middle">
                                    <a title="六合彩" style="color: #F37605;" href="#/report/statement/six-detail-user&s_time=<?= urlencode($time['s_time']); ?>&e_time=<?= urlencode($time['e_time']); ?>&user_in=<?= $getDatas['user_in']; ?>&user_nin=<?= $getDatas['user_nin']; ?>&group=user">六合彩</a>
                                </td>
