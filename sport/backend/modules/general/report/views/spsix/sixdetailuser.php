                    ...
                    <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="trinput font14">
                        ...
                        <tr>
                            <td bgcolor="#FFFFFF" align="left" class="pd10">
                                <a href="#/report/spsix/six-detail&s_time=<?= urlencode($time['s_time']); ?>&e_time=<?= urlencode($time['e_time']); ?>&user_in=<?= $getDatas['user_in']; ?>&user_nin=<?= $getDatas['user_nin']; ?>" style="color: #F37605;" title="返回上一页">返回上一页</a>
                            </td>
                        </tr>
                        <tr>
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font14 skintable line35 mgt10">
                    ...
                    foreach ($data as $key => $val) {
                        ...
                        <tr align="center">
                                ...
                                <td align="center" valign="middle"><a title="六合彩" style="color: #F37605;" href="#/spsix/index/order&start_time=<?= urlencode($time['s_time']); ?>&ent_time=<?= urlencode($time['e_time']); ?>&user_name=<?= $val['user_name']; ?>&qishu=&status=0,1,2,3"><?= $val['user_name']; ?></a>(<?= $val['pay_name'] ?>)</td>
