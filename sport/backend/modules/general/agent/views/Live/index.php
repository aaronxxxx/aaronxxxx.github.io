...
<body>
    ...
    <div class="pro_title pd10"> 代理管理：下属会员 <?= $all['user_name']; ?> live报表信息    <a href="#/agent/report/report-type&user_id=<?= $user_id; ?>&s_time=<?= urlencode($time['s_time']) ?>&e_time=<?= urlencode($time['e_time']) ?>"><span style="color:#ff9966;margin-left: 30px;">返回上一页</span></a>
       </div>
    <div id="pageMain" align="center">
      
                        <form class="trinput font14 " name="gridSearchForm" id="gridSearchForm" method="get" action="#/agent/live/index" >
                            ...
                            <tbody>
                                ...
                                <tr align="center" style="background-color:#FFFFFF; line-height:20px;">
                                    <td height="25" align="center" valign="middle" colspan="9">
                                        当前页总投注金额:<?= $all['money'] ?>元    当前页赢取金额:<?= $all['sy'] ?>元
                                    </td>
                                </tr>
                            </tbody>
                        </table>
