<table align="center" width="100%">
    <tbody><tr >
        <td  class="pd10"><font class="pro_title">&nbsp;總代理餘額手工結算</font></td>
    </tr>
    <tr>
        <?php if($user){?>
            <td  align="center" nowrap="" >
                <form name="form1" method="post" action="" id="form1">
                    <table border="1"  cellspacing="0" cellpadding="0" class="settable bordercolor" id="editProduct"  style="width: 1092px">
                        <tbody><tr>
                            <td width="16%"  align="right">總代理名：</td>
                            <td width="84%" align="left">
                                <font color="Red"><?=$user['agents_name'];?></font>
                                <input type="hidden" name="user_id" value="<?=$user['id'];?>">
                                <input type="hidden" name="save" value="ok">
                                <input name="user_name" type="hidden" id="user_name" value="<?=$user['agents_name'];?>"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td align="left"><input name="money" type="text" size="10" maxlength="10" onchange="if(isNaN(this.value)){alert('只能輸入數字');this.value='';}">
                                <span class="STYLE3">*</span><span class="STYLE5">必須為數字</span></td>
                        </tr>
                        <tr>
                            <td  align="right">理由：</td>
                            <td align="left"> <input name="about" value="總代理匯款" type="text" size="40" maxlength="255" readonly="readonly"> 註釋：理由如果包含 "用於活動" 字眼，則此次加/扣錢的金額不會在'代理存取報表'中體現。</td>
                        </tr>
                        <tr>
    ...
    $(function () {
        $("input[name=submit]").click(function (e) {
            ...
            layer.confirm('確定要提交嗎？', {icon: 3, title:'提示'}, function(index){
                ...
                $.ajax({
                    type: "POST",
                    url: "/?r=agent/default/do-money-set",
                    ...
                    success: function(data){
                        layer.alert(data,function (index) {
                            layer.closeAll();
                            window.location.href = '#/agent/default/index&user_name=<?=$user['agents_name'];?>';
                        });
                    }
                })
            });
