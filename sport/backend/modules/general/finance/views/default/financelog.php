         ...
         <p>
                ...
                <p>
                    <div>
                        ...
                        会员名：<input name="userIn" value="<?=$userIn;?>" style="width: 200px;" type="text"> (多个用户用 , 隔开)
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        忽略会员名：<input name="userNin" value="<?=$userNin;?>" type="text" style="width: 200px;"> (多个用户用 , 隔开)
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input name="gtype" type="hidden" id="gtype" value="">
                         <input id="gridSearchBtn" type="button" name="Submit" value="搜索">
                    
                         <div style="color: red;font-size: 14px;" class="pdt10">活动金额：在加款扣款界面，如果理由包含'用于活动'这四个字，那此次金额就属于活动金额，不算在盈利范围内。</div>
                    </div>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12 font12 skintable" >
                <tbody><tr  class="dailitr">
                    <td style="width: 15%" align="center" height="25"><strong>会员名</strong></td>
                    <td style="width: 15%" align="center"><strong>汇款金额</strong></td>
                    <td style="width: 14%" align="center"><strong>存款金额(排除活动金额)</strong></td>
                    <td style="width: 14%" align="center"><strong>取款金额(排除活动金额)</strong></td>
                    <td style="width: 14%" align="center"><strong>合计盈利(排除活动金额)</strong></td>
                    <td style="width: 14%" align="center"><strong>后台加钱(用于活动)</strong></td>
                    <td style="width: 14%" align="center"><strong>后台扣钱(用于活动)</strong></td>
                </tr>
                <?php
                    if($data){
                    ...
                    <?php }
                        ...
                        <tr align="center"style="line-height: 20px; background-color: rgb(255, 255, 255);">
                            <td height="40" align="center" valign="middle" colspan="7">没有数据</td>
                        </tr>
                <?php }?>
                </tbody>
            </table>
