        ...
        <div id="pageMain">
                    ...
                    <form name="gridSearchForm" id="gridSearchForm" method="get" action="#/live/user/index" onSubmit="return check();" class="trinput font14 pd10">
                            <div class="pro_title pd10">平台帐号列表</div>
                                ...
                                <input type="hidden" class="laydate-icon" name="s_time" id="s_time" value="<?php echo $start_order_time; ?>" onfocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt: 'yyyy-MM-dd HH:mm:ss'})">
                                <input type="hidden" class="laydate-icon" name="e_time" id="e_time" value="<?php echo $end_order_time; ?>" onfocus="WdatePicker({isShowClear:true,readOnly:true,dateFmt: 'yyyy-MM-dd HH:mm:ss'})">
                                <!--<p>
                                    <span>
                                ...
                                <p>
                                    ...
                                    <!-- 平台类型：
                                                        <select name="game_type" id="live_type" onChange="onurlchange()" >
                                                            ...
                                                            <option value="PT"  <?php echo $game_type == 'PT' ? 'selected' : ''; ?>>PT</option>
                                                        </select>
                                    &nbsp;&nbsp; -->
                        ...
                        <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12 skintable line35" >
							...
							foreach ($rs as $key=>$value){
                                    ...
                                    <tr align="center" onMouseOver="this.style.backgroundColor = '#EBEBEB'" onMouseOut="this.style.backgroundColor = '#ffffff'" style="background-color:#FFFFFF; line-height:20px;">
                                        ...
                                        <a href='/#/live/user/transfer&uid=<?= $value['user_id'] ?>&hall=<?php echo $value["live_type"];?>&type=IN'>转入</a> /
                                        <a href='/#/live/user/transfer&uid=<?= $value['user_id'] ?>&hall=<?php echo $value["live_type"];?>&type=OUT'>转出</a>
                                        </td>
