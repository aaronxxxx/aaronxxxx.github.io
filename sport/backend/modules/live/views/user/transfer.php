                                ...
                                <tr>
                                    <td>
                                        <select name="transform" id="transform">
                                            <option value="in" <?php if($type=='IN'){echo 'SELECTED';}?>>转入厅</option>
                                            <option value="out" <?php if($type=='OUT'){echo 'SELECTED';}?>>厅转出</option>
                                        </select>
                                    </td>
                                    <td>
                                        &nbsp;&nbsp;选择厅：
                                        <select id="platform" name="platform">
                                            ...
                                            <option value="VR" <?php echo $hall == 'VR' ? 'selected' : ''; ?>>VR厅</option>
                                            <option value="PT" <?php echo $hall == 'PT' ? 'selected' : ''; ?>>PT厅</option> -->
                                            <option value="AI" <?php echo $hall == 'AI' ? 'selected' : ''; ?>>AI厅</option>
                                        </select>
                                    </td>
                                </tr>
                            </table>
