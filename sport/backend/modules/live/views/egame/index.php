...
<div id="pageMain">
    ...
    <form name="gridSearchForm" id="gridSearchForm" method="get" action="#/live/egame/index" onSubmit="return check();" class="trinput">
        <div class="pro_title pd10">电子游艺注单</div>

        <input type="hidden" name="r" value="live/egame/index"/>
        ...
        <div class="trinput pd10 font13">
            ...
            <select name="game_type" id="live_type" onChange="onurlchange()" >
                ...
                <option value="XIN"  <?php echo $game_type == 'XIN' ? 'selected' : ''; ?>>XIN</option>
                ...
                <option value="AG_HUNTER"  <?php echo $game_type == 'AG_HUNTER' ? 'selected' : ''; ?>>HUNTER</option>
