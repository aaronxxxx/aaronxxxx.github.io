<?php use yii\widgets\LinkPager;?>
            ...
            <form name="form1" method="post" action="?r=six/index/update-result" id="form1">
                <div class="font12 trinput resulttable zudan">
                    ...
                    <p>
                        ...
                        <span>
                            <input type="button" class="form_ajax_submit_btn mgl61" data-targetid="form1" data-redirect="/#/six/index/result&t=<?=time();?>" name="submit" value="确认发布">
                        </span>
                    </p>
                </div>
            </form>

            <form name="form2" method="get" id="gridSearchForm" action="#/six/index/result">
                    ...
                    if($list){
                        foreach ($list as $key=>$val){?>
                            <tr align="center" onmouseover="this.style.backgroundColor='#EBEBEB'" onmouseout="this.style.backgroundColor='#ffffff'" style="line-height: 20px; background-color: rgb(255, 255, 255);">
                                ...
                                <?php } ?>
                                <td>
                                    <a href="#/six/index/result-edit&qishu=<?=$val['qishu']?>">编辑</a>
        ...
        $(".settle").click(function (e) {
            ...
            $.ajax({
                ...
                success: function(data){
                    layer.alert(data);
                    $(".settle").removeAttr("disabled");
                    window.location.href = '/#/six/index/result&t='+formData+"&t="+new Date().getTime();;
                }
            })
        })
    })
