            ...
            <div id="content_inner">
                ...
                <div>
                    <div id="wager_groups" class="CQ">
                        ...
                        <a href="#/six/odds/lian-ma" title="连码" class="NowPlay">连码</a>
                ...
                <?php if($data) {
                    foreach ($data as $key => $val) { ?>
                        <div id="<?=$key?>" style="display:<?php echo $key!='CH' ? 'none':"";?>" class="showT">
                            <form action="/?r=six/odds/lian-ma" method="post" name="<?=$key?>">
                                ...
                                <div id="SendB5">
                                    ...
                                    <button id="btn-save-odds" class="order" type="<?=$key;?>" data-herf="#/six/odds/lian-ma">保存</button>
                                </div>
                            </form>
                        </div>
                    <?php }
