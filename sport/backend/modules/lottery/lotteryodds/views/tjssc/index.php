...
<script>
    $().ready(function(){
        $lottery_type = '极速时时彩';
        $sub_type = '两面';
        $url = '/?r=lotteryodds/tjssc/up-liangmian';
        liangmian();
    })
    function liangmian(){
        $('#table').load('/?r=lotteryodds/tjssc/liangmian',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    function yizidingwei(){
        $('#table').load('/?r=lotteryodds/tjssc/yizidingwei',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    function longhuhe(){
        $('#table').load('/?r=lotteryodds/tjssc/longhuhe',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    function baozishunzi(){
        $('#table').load('/?r=lotteryodds/tjssc/baozishunzi',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    function niuniu(){
        $('#table').load('/?r=lotteryodds/tjssc/niuniu',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    function rate(){
        $('#table').load('/?r=lotteryodds/tjssc/rate',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    $(function(){
        ...
        $('#yizidingwei_wan,#yizidingwei').click(function(){
            ...
            $sub_type = '万定位';
            $url = '/?r=lotteryodds/tjssc/up-yizidingwei';
            yizidingwei();
        })
        ...
        $('#RATE').click(function(){
            $('.tab_type').hide();
            $sub_type = 'rate';
            $url = '/?r=lotteryodds/tjssc/up-rate';
            rate();
        })
        $('#save_odds').click(function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    layer.alert(data);
                    window.location.href="#/lotteryodds/tjssc/index&"+(new Date().valueOf())+"";
                }
            });
            return false;
        })
...
<div id="box_range">
    <div id="main">
        <div id="content">
        <h2><b></b><span class=" white">极速时时彩-赔率设置</span></h2>
