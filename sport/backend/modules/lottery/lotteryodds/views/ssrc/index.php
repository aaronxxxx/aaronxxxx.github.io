...
<script>
    $().ready(function(){
        $lottery_type = '极速赛车';
        $sub_type = '主盘势';
        $url = '/?r=lotteryodds/ssrc/up-zhupanshi';
        zhupanshi();
    })
    function zhupanshi(){
        $('#table').load('/?r=lotteryodds/ssrc/zhupanshi',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        })
    }
    function dingwei(){
        $('#table').load('/?r=lotteryodds/ssrc/dingwei',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        })
    }
    function kuaisu(){
        $('#table').load('/?r=lotteryodds/ssrc/kuaisu',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        })
    }
    function rate(){
        $('#table').load('/?r=lotteryodds/ssrc/rate',{'lottery_type':$lottery_type,'sub_type':$sub_type},function () {
            checkNumber();
        });
    }
    ...
    $(function(){
        ...
        $('#dingwei').click(function(){
            $('.tab_type').hide();
            $sub_type = '定位';
            $url = '/?r=lotteryodds/ssrc/up-dingwei';
            dingwei();
        })
        $('#guanya_ks').click(function(){
            $('.tab_type').hide();
            $sub_type = '冠亚军和-快速';
            $url = '/?r=lotteryodds/ssrc/up-kuaisu';
            kuaisu();
        })
        $('#RATE').click(function(){
            $('.tab_type').hide();
            $sub_type = 'RATE';
            $url = '/?r=lotteryodds/ssrc/up-rate';
            rate();
        })
        $('#save_odds').click(function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    layer.alert(data);
                    window.location.href="#/lotteryodds/ssrc/index&"+(new Date().valueOf())+"";
                }
            });
            return false;
        })
...
<div id="box_range">
    <div id="main">
      <div class="main-inner">
        <div id="content">
        <h2><b></b><span class=" white2">极速赛车-赔率设置</span></h2>
