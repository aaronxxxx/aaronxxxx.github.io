...
return [
    ...
    'menus'=> [
        ...
        // ],
        [
            '极速赛车<div style="display:inline-block;width:10px;"></div>'=>'#/lotteryorder/index&type=SSRC&js=0,1,2,3&p=1',
            // '幸运飞艇'=>'#/lotteryorder/index&type=MLAFT&js=0,1,2,3&p=1',
        ],
        [
            // '腾讯分分彩<div style="display:inline-block;width:10px;"></div>'=>'#/lotteryorder/index&type=TS&js=0,1,2,3&p=1',
            '老PK拾'=>'#/lotteryorder/index&type=ORPK&js=0,1,2,3&p=1',
        ],
         ...
         '彩票一键反水'=>'#/lotteryorder/fs/index&type=ALL_LOTTERY&js=0',
    ]
];
