...
<form name="form1" id="form1" method="post" action="?r=lotteryresult/gxsfc/operation&id=<?=$id?>&action=<?=$id>0 ? 'edit' : 'add'?>&s_time=<?=$query_time?>&qishu_query=<?=$qishu_query?>">
    <div class=" trinput resulttable zudan tabft13 spanmg0">
        <p>
            <span>彩票类别：</span>
            <span><strong>广西十分彩</strong></span>
        </p>
        <p>
            <span>开奖期号：</span>
        ...
        <p>
           ...
           <span><select name="ball_1" id="ball_1">
                    ...
                    <option value="21" <?php if(isset($lists) && count($lists) > 0){if($lists['0']['ball_1'] ==21 ){echo 'selected';};}?>>21</option>
                ...
                <select name="ball_2" id="ball_2">
                    ...
                    <option value="21" <?php if(isset($lists) && count($lists) > 0){if($lists['0']['ball_2']==21 ){echo 'selected';};}?>>21</option>
                ...
                <select name="ball_3" id="ball_3">
                    ...
                    <option value="21" <?php if(isset($lists) && count($lists) > 0){if($lists['0']['ball_3']==21 ){echo 'selected';};}?>>21</option>
                ...
                <select name="ball_4" id="ball_4">
                    ...
                    <option value="21" <?php if(isset($lists) && count($lists) > 0){if($lists['0']['ball_4']==21 ){echo 'selected';};}?>>21</option>
                ...
                <select name="ball_5" id="ball_5">
                    ...
                    <option value="21" <?php if(isset($lists) && count($lists) > 0){if($lists['0']['ball_5']==21 ){echo 'selected';};}?>>21</option>
                    <option value="" <?php if(isset($lists) && count($lists) > 0){if($lists['0']['ball_5']=='' ){echo 'selected';};}?>>特别号</option>
                </select>
            </span>
        </p>
        <p>
        ...
        <p>
           ...
           <span><input type="button" class="form_ajax_submit_btn mgl61" data-targetid="form1" data-redirect="#/lotteryresult/gxsfc/list&status=0&type=type=广西十分彩&<?=time()?>" name="submit" value="确认发布"></span>
        </p>
    </div>
</form>
<form name="form2" onSubmit="return queryLottery();" method="get" id="gridSearchForm" action="#/lotteryresult/gxsfc/list">
    <input name="p" type="hidden" value="1" />
     <div class="tabft13 trinput resulttable  pd10">
        <div align="left">
           开奖期号：
    ...
    if(isset($rows) && count($rows) > 0){
        foreach($rows as $key =>$val){
            ...
            <tr align="center" onMouseOver="this.style.backgroundColor='#EBEBEB'" onMouseOut="this.style.backgroundColor='#fff'" style="background-color:rgb(255, 255, 255); line-height:20px;">
                ...
                <td align="center" valign="middle"><img src="/public/lottery/images/ball_gxsfc/<?=BuLing($val['ball_1'])?>.png"></td>
                <td align="center" valign="middle"><img src="/public/lottery/images/ball_gxsfc/<?=BuLing($val['ball_2'])?>.png"></td>
                <td align="center" valign="middle"><img src="/public/lottery/images/ball_gxsfc/<?=BuLing($val['ball_3'])?>.png"></td>
                <td align="center" valign="middle"><img src="/public/lottery/images/ball_gxsfc/<?=BuLing($val['ball_4'])?>.png"></td>
                <td align="center" valign="middle"><img src="/public/lottery/images/ball_gxsfc/<?=BuLing($val['ball_5'])?>.png"></td>
                ...
                <td>
                    <a href="#/lotteryresult/gxsfc/edit&id=<?=$val['id']?>&qishu=<?= $val['qishu']?>" >编辑</a>
            ...
            $('.js_type').click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if(data=='0'){
                            alert('结算成功');
                            window.location.href='#/lotteryresult/gxsfc/list&status=0&type=广西十分彩&n_time=<?=time();?>';
                        }else if(data == '-1'){
                            ...
                            alert('注单不存在');
                            window.location.href='#/lotteryresult/index/gxsfc&status=0&type=广西十分彩&n_time=<?=time();?>';
                        }
                    }
                });
                return false;
