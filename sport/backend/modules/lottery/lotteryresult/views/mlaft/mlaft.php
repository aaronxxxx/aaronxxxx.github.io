...
?>
    <script language="javascript" src="/public/lottery/js/result_mlaft.js"></script>
        <form name="form1" id="form1" method="post" action="?r=lotteryresult/mlaft/operation&id=<?=$id?>&action=<?=$id>0 ? 'edit' : 'add'?>&s_time=<?=$query_time?>&qishu_query=<?=$qishu_query?>">
            <div class=" trinput resulttable w836 tabft13 spanmg0">
            <p>
                <span>彩票类别：</span>
                <span><strong>幸运飞艇</strong></span>
            </p>
            <p>
                <span>开奖期号：</span>
            ...
            <p>
               <span><input type="button" class="form_ajax_submit_btn mgl61" data-targetid="form1" data-redirect="#/lotteryresult/mlaft/list&status=0&type=type=极速赛车&<?=time()?>" name="submit" value="确认发布"></span>
            </p>
        </div>
        </form>
        <form name="form2" id="gridSearchForm" method="get" action="#/lotteryresult/mlaft/list">
            ...
            if(isset($rows) && count($rows) > 0){
                foreach($rows as $key =>$val){
                    ...
                    <tr align="center" onMouseOver="this.style.backgroundColor='#EBEBEB'" onMouseOut="this.style.backgroundColor='#fff'" style="background-color:rgb(255, 255, 255); line-height:20px;">
                        <td height="25" align="center" valign="middle">幸运飞艇</td>
                        <td align="center" valign="middle"><?=$val['qishu']?></td>
                        <td align="center" valign="middle"><?=$val['datetime']?></td>
                        <td align="center" valign="middle"><img src="/public/lottery/images/ball_mlaft/<?=$val['ball_1']?>.png"></td>
                        <td align="center" valign="middle"><img src="/public/lottery/images/ball_mlaft/<?=$val['ball_2']?>.png"></td>
                        <td align="center" valign="middle"><img src="/public/lottery/images/ball_mlaft/<?=$val['ball_3']?>.png"></td>
                        <td align="center" valign="middle"><img src="/public/lottery/images/ball_mlaft/<?=$val['ball_4']?>.png"></td>
                        <td align="center" valign="middle"><img src="/public/lottery/images/ball_mlaft/<?=$val['ball_5']?>.png"></td>
                        <td align="center" valign="middle"><img src="/public/lottery/images/ball_mlaft/<?=$val['ball_6']?>.png"></td>
                        <td align="center" valign="middle"><img src="/public/lottery/images/ball_mlaft/<?=$val['ball_7']?>.png"></td>
                        <td align="center" valign="middle"><img src="/public/lottery/images/ball_mlaft/<?=$val['ball_8']?>.png"></td>
                        <td align="center" valign="middle"><img src="/public/lottery/images/ball_mlaft/<?=$val['ball_9']?>.png"></td>
                        <td align="center" valign="middle"><img src="/public/lottery/images/ball_mlaft/<?=$val['ball_10']?>.png"></td>
                        ...
                        <td>
                            <a href="#/lotteryresult/mlaft/edit&id=<?=$val['id']?>&qishu=<?= $val['qishu']?>" >编辑</a>
            ...
            $('.js_type').click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if(data=='0'){
                            alert('结算成功');
                            window.location.href='#/lotteryresult/mlaft/list&status=0&type=幸运飞艇&n_time=<?=time();?>';
                        }else if(data == '-1'){
                            ...
                            alert('注单不存在');
                            window.location.href='#/lotteryresult/index/mlaft&status=0&type=幸运飞艇&n_time=<?=time();?>';
                        }
                    }
                });
                return false;
