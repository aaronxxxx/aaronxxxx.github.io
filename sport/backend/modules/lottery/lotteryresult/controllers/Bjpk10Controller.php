    ...
    public function actionOperation(){
        ...
        if($id==0){
            ...
            if($cqsfc_qihao && $cqsfc_qihao['0']["id"] > 0){
                ...
                $saveModel->save();
                $str = 'bjpk10'.'新增期數:'.$qishu.'號碼:'.$_POST["ball_1"].','.$_POST["ball_2"].','.$_POST["ball_3"].','.$_POST["ball_4"].','.$_POST["ball_5"].','.$_POST["ball_6"].','.$_POST["ball_7"].','.$_POST["ball_8"].','.$_POST["ball_9"].','.$_POST["ball_10"];
