function sscAnimateEnd(o) {
    ifopen && (animate.sscAnimateEnd(o.preDrawCode, o.id, o.counttime, !1), videoTools.inseartData(o), datestr = o.counttime, preDrawCode = o.preDrawCode)
}
...
$(function () {
    videoTools.createNum(), setTimeout(function () {
        setTimeout(function () {
            $(".loading").fadeOut(600)
        }, 100)
    }, 200), $(".menubox").on("click", ".tyrbtn", function () {
...
animate.sscAnimateEnd = function (o, e, n, s) {
    if (ifopen) {
        videoTools.ifsund() && ifopen && ($("#bgsound").attr("src", "sound/over.mp3"), videoTools.sounds.soundsT.play("bgsound")), clearInterval(animateID[e]);
        var i = $(e).find(".box");
        $(".oping").hide(), $(".djs").show();
        var t = [];
        $(i).each(function (e) {
    ...
    var o = 0,
        e = setInterval(function () {
            ++o >= 8 && (clearInterval(e), animate.sscAnimateEnd(videoTools.createNum(), "#numBig", datestr, !0), setTimeout(function () {
                setTimeout(function () {
                    animate.sscAnimateEnd(preDrawCode, "#numBig", datestr, !0), $(".menubox .tyrbtn").removeAttr("id")
                }, 100)
            }, 8e3))
        }, 1e3)
},
