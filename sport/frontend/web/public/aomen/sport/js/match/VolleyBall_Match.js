...
function setbet(typename_in,match_name_in,match_id_in,point_column_in,ben_add_in,is_lose,xx_in,tztype){
    ...
    touzhutype = tztype;
    $.post("/?r=sport/volleyball/volleyball-match",
    {ball_sort:typename_in,touzhuxiang:match_name_in,match_id:match_id_in,
		point_column:point_column_in,ben_add:ben_add_in,is_lose:is_lose,xx:xx_in,
