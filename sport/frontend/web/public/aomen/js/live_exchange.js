    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if(/android/i.test(navigator.userAgent)){
				document.write("<script>window.location.href = '/?r=mobile/quota/index';</script>");//这是Android平台下浏览器
			}else if(/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent)){
				document.write("<script>window.location.href = '/?r=mobile/quota/index';</script>");//这是iOS平台下浏览器
			}else{
