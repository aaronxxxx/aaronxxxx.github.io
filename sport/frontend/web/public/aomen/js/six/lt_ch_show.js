(function (GameSpace) {
    ...
    GameSpace.ChShow.prototype = {
        ...
        init : function () {
            ...
            if (typeof document.lt_form != 'undefined') {
                ...
                //绑定却换玩法开关  单选框
                var _this = this;
                $("input[type=radio][name=rtype]",_form).each(function () {//绑定单选框
  ...
  //              alert(n.length);
        ...
        onSwitchClk : function (me) {
            ...
            var _val = this.value;//获取单选框的值
//            alert("点击单选框"+_val);
            var input01=document.getElementById('ch_name');
            me._nowRtype = _val;
            if(_val == 'CH_2'){
                 input01.setAttribute("value", "二全中");
                 me.minChk = 2;
            }if(_val == 'CH_2S'){
                 input01.setAttribute("value", "二中特");
                 me.minChk = 2;
            }if(_val == 'CH_2SP'){
                 input01.setAttribute("value", "特串");
            }
            if (_val == 'CH_32' || _val == 'CH_3') {//三全中或者三中2
                if(_val == 'CH_32'){
                    input01.setAttribute("value", "三中二");
                   
                }else{
                    input01.setAttribute("value", "三全中");
                    
                }
                me.minChk = 3;//最少勾选3个
                me.maxDanChk = 2;//胆码最多勾选
//                if (!me._switchSub.xf.checked) {//对碰玩法却换开关
//                	
//                    $(me.rsTableTag).show();
//                    $(me.tab2).show();
//                }
            ...
            if (_val == 'CH_4') {
                 input01.setAttribute("value", "四全中");
                me.minChk = 4;
                me.maxDanChk = 3;
...
//            }
//
            $(me._inpNum).each(function() {this.checked = false;});//点单选框默认全部不选中
//            alert("开启单选框"); 
            me.enableForm('Y');//开启单选框
           var _numColor = numColor;//球号颜色
            var td, span, inp, k;
            ...
            //me.selectRS('R');
            //me._switchRS.checked = false; 正副号
            //me.toggleRS();
           ...
           // me._SnumTag.innerHTML = '';
            ...
            me._ballTag.innerHTML = '<p style="color:#5b3506;">' + msg.replace("%s", me.minChk) + '<span style="background-color:rgb(0,255,0);">&nbsp;&nbsp;&nbsp;</span></p>';
            me.filterRound();
        },
        /**
         * 绑定 胆拖 生肖对碰等 事件
...
//            me._SnumTag.innerHTML = '';
            ...
            var _numColor = numColor, _nowChk = me.nowChk, _inpNum = me._inpNum, a = [], v;
           //alert("当前勾选"+_nowChk);
            ...
            if (_nowChk <= me.maxChk && _nowChk >= me.minChk) {
                ...
                var pageString = '<p class="pcolor">组合共 <font id="TotalBall" color="red">'+totalArray.length+'</font> 组</p>';
               
 //               var formt=document.getElementById('LAYOUTFORM');
//                var inputbg=document.getElementById('gold');
//                formt.removeChild(inputbg);
 //                   $("#gold02").remove(); 

                for(var m=0;m<totalArray.length;m++){
                    if(m==totalArray.length-1){
                        pageString += '<p class="pcolor"><div style="color:rgb(187,187,255);font-weight:bold;clear:both;">组合'+(m+1)+':</div><p class="pcolor">'+totalArray[m]+'</p><span style="background-color:rgb(0,255,0);">&nbsp;&nbsp;&nbsp;</span></p>';
//                        alert(totalArray[m]);
                        ...
                        input1.setAttribute("id", "gold02");
                        input1.setAttribute("name", "totalArray[]");
                        input1.setAttribute("value", totalArray[m]);
                        
                       // form1.appendChild(input1);
                    }else{
                      
                        pageString += '<p class="pcolor"><div style="color:rgb(187,187,255);font-weight:bold;clear:both;">组合'+(m+1)+':</div><p class="pcolor">'+totalArray[m]+'</p></p>';
                        var form1=document.getElementById('form2');
...
//            alert(this.checked);
            ...
            if (this.checked) {
                this.parentNode.style.backgroundColor = '#f8d23c';
            } else {
        ...
        onSpaClk : function(me) {
            ...
            if (this.checked) {
                ...
                if (me.nowSpa > 2) {
                    layer.alert((Lang('Msg2_AN')).replace('%s',2));
                    me.nowSpa--;
                    this.checked = false;
                }
                me.nowSpa++;
            ...
            if (this.checked) {
                this.parentNode.parentNode.style.backgroundColor = '#f8d23c';
            } else {
                this.parentNode.parentNode.style.backgroundColor = '';
            }
        },
        ...
        onFinClk : function (me) {
            ...
            if (this.checked) {
                ...
                if (me.nowFin > 2) {
                    layer.alert((Lang('Msg2_LF')).replace('%s',2));
                    me.nowFin--;
                    this.checked = false;
                }
                me.nowFin++;
        ...
        onCrossAddClk : function (me) {
            ...
            var _d = Lang('del');
            if ((divs.length - 1) >= 49) {
                layer.alert(Lang('Msg8_OfTouch4'));
            } else {
                _p.innerHTML = 'X';
        ...
        onQuickAtagClk : function (me) {
            ...
            if ($.inArray(key, _color) >= 0) {
                ...
                _sel = (me.an2no[idx].replace(new RegExp(' ',"gm"),'')).split(','); 
        ...
        onDtDClk : function (me) {
            ...
            if (inp.checked) {
                ...
                if (_count >= me.maxDanChk) {
                    layer.alert((Lang('Msg1_OfTouch5')).replace('%',me.maxDanChk));
                    return false;
                }
                inp.checked = true;
                td.style.backgroundColor = '#f8d23c';
                inpT.checked = false;
            ...
            for ( var k in me._inpDtcC) {
                if ((_numColor[k] == _class) && (!me._inpDtcD[k].checked)) {
                    ...
                    if (x == 1) {
                        ...
                        inpC.checked = true;
                        spanC.style.display = '';
                        tdC.style.backgroundColor = '#f8d23c';
                        inpD.checked = false;
                        spanD.style.display = 'none';
                        tdD.className = '';
                    }
        ...
        onFormSubmit : function (me) {
            ...
            if (_count == 0) {
                layer.alert(Lang('ALERT_PLS_SELECT_WAGERS_TYPE'));
                return false;
            }
            _count = 0;
...
//            }
            if (_count < me.minChk && !isSub) {
                layer.alert(Lang('Msg1_NI').replace('%s',me.minChk));
                return false;
            } else {
                $.ajax({
                    url:this.action,
        ...
        drawDantuoSpa : function (me) {
            ...
            if (tables.length == 0) {
                ...
                for (i = 0; i < 12; i++) {
                    ...
                    tr.appendChild(td);
                    var a = (this.an2no[i].replace(new RegExp(' ',"gm"),'')).split(','), _a ;
                    for (j = 0; j < 5; j++) {
                        td = _td.cloneNode(1);
