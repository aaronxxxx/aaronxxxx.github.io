    ...
    GameSpace.NxShow.prototype = {
        ...
        init : function (res) {
            ...
            if (typeof document.lt_form != 'undefined') {
                ...
                if (arguments.length > 0) {
                    var a = arguments[0];
                    a = {SELECT_1: res['odds_NX1'], 
                        SELECT_2: res['odds_NX2'], 
                        SELECT_3: res['odds_NX3'], 
                        SELECT_4: res['odds_NX4'],
                        SELECT_5: res['odds_NX5'],
                        SELECT_6: res['odds_NX6'],
                        SELECT_7: res['odds_NX7'],
                        SELECT_8: res['odds_NX8'],
                        SELECT_9: res['odds_NX9'],
                        SELECT_10: res['odds_NX10'],
                        SELECT_11: res['odds_NX11']
                    };
                    if (typeof a == 'object') {
                        for (var k in a) {
                            this.nxAry[k] = a[k];
                ...
                if(this._btnSend){
                    this._btnSend.addEventListener('click', function() {
                        this.onFormSubmit && this.onFormSubmit.call(this.form, _this);
                    });
                }
        ...
        onGrpAClk : function (me) {
            ...
            if (me._switchRadio['IN'].checked || me._switchRadio['OUT'].checked) {
                ...
                for (var i = 0; i < 6; i++) {
                    ...
                    me._inpNx[_select[i]].parentNode.style.backgroundColor = '#f8d23c';
                }
                // 顯示醒目提示
                for (k in me._aGrpTag) {
                    $(me._aGrpTag[k]).removeClass('ON');
            ...
            if (me._switchRadio['IN'].checked || me._switchRadio['OUT'].checked) {
                ...
                if (me._switchRadio['IN'].checked) {
                    if (me.nowChk >= me.maxChk + 1) {
                         ...
                         layer.alert(Lang('game_type12_sx_in') + (Lang('Msg2_AN')).replace('%s',me.maxChk));
                    }else{
                        me.fixOdds = me.nxAry["SELECT_" + me.nowChk.toString()];
                    }
                    var odds = me.fixOdds;
                    ...
                    if (me.nowChk >= me.maxChk) {
                         ...
                         this.checked = false;
                         this.parentNode.style.backgroundColor = '';
                         layer.alert(Lang('game_type12_sx_out') + (Lang('Msg2_AN')).replace('%s', '10'));
                    }else{
                        me.fixOdds = me.nxAry["SELECT_" + (12-me.nowChk).toString()];
                    }
                    var odds = me.fixOdds;
                ...
                //动态添加赔率
                me._oddsTag.innerHTML = ( isNaN(odds) || me.nowChk == 0 ) ? '' : odds;//chkjs( odds , 2);
            } else {
                layer.alert(Lang('Msg4_Quick'));
                this.checked = false;
            }
        ...
        onFormSubmit : function (me) {
            ...
            if (me._switchRadio['IN'].checked == true) {
                if (_count >= (me.maxChk + 2)) {
                    ...
                    layer.alert(Lang('game_type12_sx_in') + (Lang('Msg1_AN')).replace('%s',me.minChk));
                    return false;
                } else {
                    $.ajax({
                        url:this.action,
                        ...
                        error : function (res) {
                        	...
                        	(me.onError instanceof Function) && me.onError();}
                    });
                }
                ...
                if (_count >= 12) {
                    ...
                    layer.alert(Lang('game_type12_sx_out') + (Lang('Msg1_AN')).replace('%s','1'));
                    return false;
                } else {
                    $.ajax({
                        url:this.action,
        ...
        clearBgColor : function () {
            ...
            for (var k in this._inpNx) {
                 this._inpNx[k].parentNode.parentNode.style.backgroundColor = '';
            }
        },
        onError : function () { }
    }
