(function (namespace) {
    ...
    namespace.memberCenter = {
        memberData : function () {
                ...
                $.ajax({
                    ...
                    success : function (txt) {
                        ...
                        if (_view.inner_box.find('#PasswdIsOkMsg').length > 0) {
                            layer.alert(_view.inner_box.find('#PasswdIsOkMsg').text());
                        }
                        _view.callBack();
                    }
                });
            ...
            _loadScrpt('/resource/common/js/lottery/lhc/inte/jquery.slideMenu.js', '/resource/common/css/lottery/lhc/pitaya/jquery.slideMenu.css', function () {
        ...
        gameResult : function () {
            ...
            if (_date_start.length > 0 && _date_start[0].type == 'text') {
                _loadScrpt("/inte/js/ui.datepicker.js", "/resource/css/pitaya/ui.datepicker.css", function () {
