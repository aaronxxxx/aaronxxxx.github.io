...
//                var _disabeleGold = _getCookie('EnableGold');
        ...
        if (!_isAndroid) {
            //停用快選金額選單
            a = _a.cloneNode(1);
            a.innerHTML = "<img src='/public/aomenPC/img/warn.gif' alt='%" + __('expired') + "%' style='border:0;vertical-align:middle;' />&nbsp;<b style='background-color:red;color:#fff'>" + __('expired') + "</b>";
...
//            });
        ...
        resetGold : function (_newGold) {
            ...
            if (!_isAndroid) {
                //停用快選金額選單
                a = _a.cloneNode(1);
                a.innerHTML = "<img src='/aomen/images/warn.gif' alt='%" + __('expired') + "%' style='border:0;vertical-align:middle;' />&nbsp;<b style='background-color:red;color:#fff'>" + __('expired') + "</b>";
                a.style.fontWeight = 'bold';
                a.onclick = function () { me.onStopClick(); };
                a.onmouseover = _over;
                a.onmouseout = _out;
