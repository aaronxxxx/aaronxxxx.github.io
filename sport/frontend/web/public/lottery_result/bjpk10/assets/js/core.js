...
(function () {
    ...
    var p = ['https://1680218.com/', 'https://1682011.cn/', 'https://1680210.com/', 'https://1680118.com/', 'https://1680100.com/'],
        e = document,
        g = window,
    ...
    n.prototype = {
        ...
        b: function (a) {
            ...
            h.src = "https://qhm1.cnzz.com/heatmap.gif?" + b;
            return !0
        },
        d: function () {
            ...
            for (var k = 0; k < p.length; k++) {
                var f =
                    p[k];
                if (-1 !== f.indexOf("*")) {
                    for (var e = 0; e < d.length; e++) var c = "/\\" + d[e] + "/g",
