(function () {
    ...
    k.prototype = {
            ...
            try {
                if ("undefined" === typeof e._cz_account || e._cz_account === this.c) {
                    ...
                    if ("[object Array]" === {}.toString.call(e._czc))
                        for (var a = e._czc, b = 0, c = a.length; b < c; b++) this.L(a[b]);
                    this.Ea()
                }
            } catch (d) {
                g(d, "pP failed")
        ...
        za: function () {
            try {
                return "none" === this.w() ? this.a.Ka = 0 : this.a.Ka = parseInt(((new Date).getTime() -
                    1E3 * this.w()) / 1E3)
            } catch (a) {
                g(a, "gST failed")
            }
        ...
        Z: function () {
            try {
                ...
                } else "none" !== this.a.l ? b.push("cnzz_eid=" + f(this.a.l)) : (d = Math.floor(2147483648 * Math.random()) + "-" + this.D + "-" + this.M(this.o()), b.push("cnzz_eid=" + f(d))), b.push("ntime=" + this.D), 0 < b.length ? (a += f(b.join("&")), a += "; expires=" + c.toUTCString(), a += "; path=/") : a += "; expires=" + (new Date(0)).toUTCString();
                h.cookie = a
            } catch (n) {
                g(n, "sS failed")
            }
