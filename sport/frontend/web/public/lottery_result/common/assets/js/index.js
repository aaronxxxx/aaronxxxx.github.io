...
method.listData = function (date) {
    $.ajax({
        ...
        url: "/?r=lottery/lottery-result-api/json-history-data&gtype=SSRC" , //歷史開獎結果
        type: "GET",
        data: {
            "lotCode": lotCode
        },
...
method.todayData = function (date) {
    ...
    //     url: "json/getPksDoubleCount.json",
    //     type: "GET",
    //     data: {
    //         "lotCode": lotCode
    //     },
...
method.longData = function (date) {
    ...
    //     url: "https://www.kbcp88.com/?r=lottery/lottery-result/json-history-data&gtype=BJPK",
    //     type: "GET",
    //     data: {
    //         "lotCode": lotCode
    //     },
