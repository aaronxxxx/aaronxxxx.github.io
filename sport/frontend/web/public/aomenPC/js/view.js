(function (space) {
    ...
    space.ViewBox.prototype = {
        ...
        onShow: function (_href, _title) {
            ...
            ary.pop();
            base_dir = ary.join('/');
            if(_href=='/?r=member/lottery/lottery') {//下注历史跳转到个人中心的交易记录中
                var newwin = window.open(_href, "_blank", 'width=1034px,height=636px,top=200px,left=400px;', '下注历史');
                $.ajax({
            ...
            $.ajax({
                ...
                success: function(txt) {
                    // if(_href=='/?r=member/lottery/lottery'){//下注历史跳转到个人中心的交易记录中
                    //     $('.view-mask').css('display','none');
                    //     window.open(_href, "_blank",'width=1034px,height=636px,top=200px,left=400px;','下注历史');
                    //     return false;
                    // }
