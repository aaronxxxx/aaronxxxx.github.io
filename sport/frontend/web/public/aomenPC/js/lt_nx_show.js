        ...
        onGrpAClk : function (me) {
            ...
            if (me._switchRadio['IN'].checked || me._switchRadio['OUT'].checked) {
                ...
                for (var i = 0; i < 6; i++) {
                    ...
                    me._inpNx[_select[i]].parentNode.parentNode.style.backgroundColor = 'yellow';
                }
                // 顯示醒目提示
                for (k in me._aGrpTag) {
                    $(me._aGrpTag[k]).removeClass('ON');
        ...
        onFormSubmit : function (me) {
            ...
            if (me._switchRadio['IN'].checked == true) {
                if (_count >= (me.maxChk + 2)) {
                    ...
                    new_alert (Lang('game_type12_sx_in') + (Lang('Msg1_AN')).replace('%s',_count));
                    return false;
                } else {
                    $.ajax({
                        url:this.action,
                        ...
                        success:function (data) {
                            ...
                            var userMoney = $('#user_Money').val();
                            document.getElementById("bet-credit").innerHTML = userMoney;
                            betO.init(min, max, "9999999", "9999999",userMoney, "");
