...
function updateOpenTime() {
	$.get("/?r=lottery/pl3/index/get-front-info",function(data){
...
//更新开奖号码
function auto(ball) {
	$.get("/?r=lottery/pl3/index/get-k-j-result", function(data){
...
//    }
    ...
    $.post("/?r=lottery/pl3/index/prepare-order",{data:betjsonstr,_csrf:csrfToken},function(data){
    	...
    	if(data.code=='1'){
        	...
        	layer.confirm(data.msg, {btn:['确认','取消']}, 
            		function(index){
		    			document.orders.reset();
		    			layer.close(index);
		    			$.post("/?r=lottery/pl3/index/insert-order",{data:betjsonstr,_csrf:csrfToken}, function(data){
		    				if(data==null){
