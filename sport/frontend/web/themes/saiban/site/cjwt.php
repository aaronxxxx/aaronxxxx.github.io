...
<div id="content">
	<div class="wrapper">
		<div id="un-lobby">
			...
			<article id="articles">
				<div id="Union">
					<ul class="mtab-menual menu">
						<li data-btn="1">一般问题</li>
						<li data-btn="2">游戏及投注问题</li>
						<li data-btn="3">技术常见问题</li>
					</ul>
					<div id="Union1">
						<h4>1. 星光汇娱乐城-实力怎样？</h4>
						<p>您好，请参阅主页“关于我们”。</p>
					...
					<div id="Union2">
						<h4>1. 星光汇娱乐城-有哪些游戏？</h4>
						<p>您好，星光汇娱乐城-目前为您提供“运动博弈”最全的“真人娱乐”和“电子游艺”“彩票游戏”五大电子平台组合、额度无需转换。</p>
					...
					<div id="Union3">
						...
						<ol>
							<li>任何可以接上互联网的计算机。</li>
							<li>SVGA显示适配器–最少要1204x768像素256色彩以上。</li>
							<li>区域宽带。</li>
							<li>Windows , Mac OS X , Linux作业系统。</li>
							<li>Internet Explorer浏览器v6.0 或以上 (版本7.0 或以上更好)，Mozilla Firefox (浏览器v3.0 或以上)，Opera (浏览器v8.0 或以上)，Chrome(浏览器v6.0 或以上)，Safari (浏览器v4.0 或以上)</li>
							<li>要浏览在线娱乐场，你可以在 Macromedia网站下载Macromedia Flash Player浏览器附加程序(8.0或以上版本)。</li>
						</ol>
					</div>
				</div>
			</article>
...
<script>
	$(document).ready(function() {
		$('.menu li:first').addClass('mtab');
		$('.menu li').click(function() {
			var menuBtn = $(this).attr('data-btn');
			var menuTable = $('#Union').find("#" + "Union" + menuBtn);
			$('.menu li').removeClass('mtab');
			$(this).addClass('mtab');
			$('#Union').find('div').hide();
			menuTable.show();
		})
