...
//onclick 按钮跳转    r=跳转路径
function click_url(r) {
    if (r == '/cl/main.php') {
        if (window.parent.document.body) {
            window.parent.document.body.style.background = "url(/images/bg01_x.jpg) no-repeat scroll center top";
        } else {
            document.body.style.background = "url(/images/bg01_x.jpg) no-repeat scroll center top";
        }
        ...
        window.parent.document.getElementById("mainFrame").style.height = clh - toph - 3;
        //window.parent.document.getElementById("bottomFrame").style.display = "block";
        window.parent.document.getElementById("bottomFrameDiv").style.display = "block";
        window.parent.document.getElementById("TplFloatPic_0").style.display = "block";
    } else if (r == '/member/lt/' || r == '/member/b5/b5.php?gtype=CQ&amp;rtype=605') {
        if (window.parent.document.body) {
            window.parent.document.body.style.background = "url(/images/bg02_x.jpg) no-repeat scroll center top #907023";
        } else {
            document.body.style.background = "url(/images/bg02_x.jpg) no-repeat scroll center top #907023";
        }
        ...
        $(window.parent.document).find("#mainFrame").height(750);
        window.open(r, "mainFrame");
        var toph = window.parent.document.getElementById("topFrame").height;
        var clh = window.parent.document.documentElement.clientHeight;
        // $(window.parent.document).find("#mainFrame").height(clh-toph-3);
        // window.parent.document.getElementById("bottomFrame").style.display = "block";
        window.parent.document.getElementById("bottomFrameDiv").style.display = "block";
        window.parent.document.getElementById("TplFloatPic_0").style.display = "blcck";
    } else {
        if (window.parent.document.body) {
            window.parent.document.body.style.background = "url(/images/bg02_x.jpg) no-repeat scroll center top #907023";
        } else {
...
function BBOnlineService() {
    window.open('http://messenger.providesupport.com/messenger/18f918i02oe3z09210gsder177.html', '', 'menubar=no,status=yes,scrollbars=yes,top=150,left=400,toolbar=no,width=705,height=520');
}