    ...
    <div class="round-table">
        <table id="HistoryTab" class="ListTr">
            ...
            <tr style="text-align:right;">
                ...
                " href="/?r=six/sixtop/datecount&gamedate=<?=date('Y-m-d')?>"><?=date('Y-m-d')?></a>
                </td>
            ...
            <tr style="text-align:right;">
                ...
                " href="/?r=six/sixtop/datecount&gamedate=<?=date('Y-m-d', strtotime('-1 day'))?>"><?= date('Y-m-d', strtotime('-1 day'))?></a>
                </td>
            ...
            <tr style="text-align:right;">
                ...
                " href="/?r=six/sixtop/datecount&gamedate=<?= date('Y-m-d', strtotime('-2 day'))?>"><?=date('Y-m-d', strtotime('-2 day'))?></a>
                </td>
            ...
            <tr style="text-align:right;">
                ...
                " href="/?r=six/sixtop/datecount&gamedate=<?= date('Y-m-d', strtotime('-3 day'))?>"><?= date('Y-m-d', strtotime('-3 day')) ?></a>
                </td>
            ...
            <tr style="text-align:right;">
                ...
                " href="/?r=six/sixtop/datecount&gamedate=<?=date('Y-m-d', strtotime('-4 day'))?>"><?=date('Y-m-d', strtotime('-4 day'))?></a>
                </td>
            ...
            <tr style="text-align:right;">
                ...
                " href="/?r=six/sixtop/datecount&gamedate=<?=date('Y-m-d', strtotime('-5 day'))?>"><?=date('Y-m-d', strtotime('-5 day'))?></a>
                </td>
            ...
            <tr style="text-align:right;">
                ...
                " href="/?r=six/sixtop/datecount&gamedate=<?=date('Y-m-d', strtotime('-6 day'))?>"><?=date('Y-m-d', strtotime('-6 day'))?></a>
                </td>
