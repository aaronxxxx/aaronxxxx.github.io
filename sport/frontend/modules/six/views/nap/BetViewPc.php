<div class="inner">
    ...
    <div class="msg-text">
        <form name="MyForm" action="/?r=six/nap/bet-view" method="get" onsubmit="return false;">
        ...
        <form name="LAYOUTFORM" action="/?r=six/index/six-order" method="post" onsubmit="return false">
