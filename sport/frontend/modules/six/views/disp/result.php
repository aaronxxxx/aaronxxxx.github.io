            ...
            <div class="lianma-info pb-4 pl-4 pr-4 pt-4">
                <div class="tabinner">
                    <div class="infos">
                        ...
                        <ul class="sixTable">
                            <?php 
                                $spresult_count = count($six_result);
                                for ( $i=0 ; $i< $spresult_count ; $i++ ) {?>
                                <li class="d-flex">
                                        <span class="sx-1" style="width:20% !important;"><?=substr( $six_result[$i]['create_time'], -8, 5)?></span>
                                        <span class="sx-2" style="width:30% !important;"><?= $six_result[$i]['qishu']?></span>
                                        <span class="sx-3" style="width:50% !important;">
                                            <ul class="d-flex justify-content-center">
                                                <ol class="sixResultBall mr-1 sixball_<?= $six_result[$i]['ball_1']?>"><?= $six_result[$i]['ball_1']?></ol>
                                                <ol class="sixResultBall mr-1 sixball_<?= $six_result[$i]['ball_2']?>"><?= $six_result[$i]['ball_2']?></ol>
                                                <ol class="sixResultBall mr-1 sixball_<?= $six_result[$i]['ball_3']?>"><?= $six_result[$i]['ball_3']?></ol>
                                                <ol class="sixResultBall mr-1 sixball_<?= $six_result[$i]['ball_4']?>"><?= $six_result[$i]['ball_4']?></ol>
                                                <ol class="sixResultBall mr-1 sixball_<?= $six_result[$i]['ball_5']?>"><?= $six_result[$i]['ball_5']?></ol>
                                                <ol class="sixResultBall mr-1 sixball_<?= $six_result[$i]['ball_6']?>"><?= $six_result[$i]['ball_6']?></ol>
                                                <ol class="sixResultBall sixball_<?= $six_result[$i]['ball_7']?>"><?= $six_result[$i]['ball_7']?></ol>
                                            </ul>
                                        </span>
                                    </li>
