<script>
	window.onload = function() {
		...
		_lt.init("SPbside", "{$showTableN}"); //初始化设定 包括 设定请求ajax 地址
...
<main class="sixMain">
<input id="lotteryName" type="hidden" value="六合彩 特别号B面">
    <?php include 'header.php';?>
    <?php include 'fast_bet_lhai.php';?>
		<section class="g-nr" id="Game">
                    <form name="newForm" id="newForm" action="/?r=six/index/six-order" method="post" class="pb-1">
                        <div  class="p-info p-info2 mb-2">
                            <div class="round-table mb-2">
