...
window.onload = function(){
  ...
  <main class="sixMain">
    <input id="lotteryName" type="hidden" value="六合彩 连码">
      ...
      <?php  if($lastOne){?>
        ...
        <div id="Game">
            <form name="lt_form" id="lt_form" method="post" action="/?r=six/ch/mobile-bet-view" onSubmit="return false;" class="Aside">
