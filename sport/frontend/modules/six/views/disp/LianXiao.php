...
<main class="sixMain">
    <input id="lotteryName" type="hidden" value="六合彩 连肖">
    <?php include 'header.php';?>
    <!-- <?php include 'fast_bet_lhai.php';?> -->
    <?php if($lastOne){?>
    <form name="lt_form" id="lt_form" method="post" action="/?r=six/lx/mobile-bet-view" onSubmit="return false;" class="Aside">
        <section class="pk-list" id="content_inner">
            <div class="round-table pt-2" id="table1">
                ...
                <!-- <div class="qiu qiu_four">
                    <ul>
                        <li class="act"><input type="radio" value="LF2" name="rtype">二尾碰</li>
                        <li><input type="radio" value="LF3" name="rtype"> 三尾碰</li>
                        <li><input type="radio" value="LF4" name="rtype">四尾碰</li>
                        <li><input type="radio" value="LF5" name="rtype">五尾碰</li>
                    </ul>
                </div> -->
            </div>
            ...
            <!--尾碰-->
            <!-- <div class="qiu_one">
                <div class="round-table" id="table3">
                    <div class="p-info" style="display:block;">
                        <div class="infos">
                            <p class="tit"><span>尾数</span><span >号码</span><span>勾选</span></p>
                            <ul>
                                <?php
                                for($i=0;$i<10;$i++){?>
                                    <li>
                                        <span><?= $i;?></span>
                                        <span><?php $z='';for($j=0;$j<5;$j++){ if($j!=0 || $i!=0){$z .= ','.$j.$i;}} echo substr($z,1);?></span>
                                    <span>
                                        <label>
