...
<main class="sixMain">
    <input id="lotteryName" type="hidden" value="六合彩 合肖">
    <?php include 'header.php';?>
    <!-- <?php include 'fast_bet_lhai.php';?> -->
    <?php if($lastOne){?>
        <form name="lt_form" id="lt_form" method="post" action="/?r=six/nx/mobile-bet-view" onSubmit="return false;" class="Aside">
