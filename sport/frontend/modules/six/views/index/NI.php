                        ...
                        <?php if(!empty($lastOne)){?>
                            <div id="wager_groups" class="LT">
                                ...
                                <dl id="NAVPLAY" style="height: 312px;">
                                    ...
                                    <dd><a class="NowPlay" href="/?r=six/index/index&rtype=NI">自选不中</a> </dd>
                            ...
                            <div id="Game">
                                <form name="lt_form" id="lt_form" method="post" action="/?r=six/ni/bet-view" target="_top" onsubmit="return false" class="Aside">
