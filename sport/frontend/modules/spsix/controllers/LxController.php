...
class LxController extends BaseController  {
    ...
    public function actionBetView(){
        ...
        if ($is_lx == "true") {
            ...
            $gid = "LX";
            if ($rType == "LX2") {
                $odds_LX = SpsixLotteryOdds::getOdds("LX2");
                $lx_sub_name = "二肖连";
                $minChk = 2;
            } elseif ($rType == "LX3") {
                $odds_LX = SpsixLotteryOdds::getOdds("LX3");
                $lx_sub_name = "三肖连";
                $minChk = 3;
            } elseif ($rType == "LX4") {
                $odds_LX = SpsixLotteryOdds::getOdds("LX4");
                $lx_sub_name = "四肖连";
                $minChk = 4;
            } elseif ($rType == "LX5") {
                $odds_LX = SpsixLotteryOdds::getOdds("LX5");
                $lx_sub_name = "五肖连";
                $minChk = 5;
            }
            $selectArray = $lxArray;
        ...
        elseif ($is_lf == "true") {
            ...
            $gid = "LF";
            if ($rType == "LF2") {
                $odds_LF = SpsixLotteryOdds::getOdds("LF2");
                $lx_sub_name = "二尾碰";
                $minChk = 2;
            } elseif ($rType == "LF3") {
                $odds_LF = SpsixLotteryOdds::getOdds("LF3");
                $lx_sub_name = "三尾碰";
                $minChk = 3;
            } elseif ($rType == "LF4") {
                $odds_LF = SpsixLotteryOdds::getOdds("LF4");
                $lx_sub_name = "四尾碰";
                $minChk = 4;
            } elseif ($rType == "LF5") {
                $odds_LF = SpsixLotteryOdds::getOdds("LF5");
                $lx_sub_name = "五尾碰";
                $minChk = 5;
            }
            $selectArray = $lfArray;
