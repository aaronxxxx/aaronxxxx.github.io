...
//			for($i=1;$i<=6;$i++){
//				$var='odds'.$i.'_other';
//				$$var=SpsixLotteryOdds::getOddsByBallType('N'.$i, 'other');
//			}
//            for ($i = 1; $i < 7; $i++) {
//				$var='odds'.$i.'_other';
//				$odds_other=$$var;
...
//			for($i=1;$i<=6;$i++){
//				$var='odds_NAP'.$i;
//				$$var=SpsixLotteryOdds::getOdds('NAP'.$i);
//			}
...
//            if(!SpsixLotteryOrder::getMaxMoneyAlready_lhc($userid, $qishu)){$max_money_already=0;
//            }else{
//                $max_money_already = SpsixLotteryOrder::getMaxMoneyAlready_lhc($userid, $qishu);
//            }
...
//        $kjresult = LotteryResultSplhc::getSixResult(' ORDER BY qishu DESC limit 0,10');//近十期开奖结果
...
//            }
//            $win_money = 0;
//            $id_sub = SpsixLotteryOrderSub::AddSixOrder($datereg, $bet_info, $bet_rate, $bet_money_one, $win_money, $fs_money, $balance);//添加下注明细
...
//            if ($fsRow['splhc_bet'] <= $bet_money_one) {
//                $fs_money = $bet_money_one * $fsRow['splhc_bet_reb'];
//            }
//            $id_sub = SpsixLotteryOrderSub::AddSixOrder($datereg, $bet_info, $bet_rate, $bet_money_one, $win_money, $fs_money, $balance);
//            $datereg_sub = date('YmdHis') . $id_sub;
//            $r = SpsixLotteryOrderSub::UpdateSixOrder($id_sub, $datereg_sub);                                 //更新插入下注明显的子订单号
//            if(!$id_sub || !$r){
//                SpsixLotteryOrderSub::DelSixOrder($id_sub);                                                   //删除订单明细
