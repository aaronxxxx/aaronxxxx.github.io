<div id="RuleDiv">
  <div class="slide-index">
    <p class="title">备注：<span style="font-size:14.5px;color:red;">为了避免争议，所有彩种下注完毕，必须到会员中心查看[下注记录]，若有异常注单，不管输赢一律退回本金。</span></p>
<!--    <ul>-->
<!--            <li><a href="#LT_rule" title="极速六合彩">极速六合彩</a></li>-->
<!--          </ul>-->
  </div>
...
<li>『极速六合彩』当次确认下注时间与上次确认下注时间10秒钟内：出现同群组且内容相同2笔以上之注单，本公司只承认一笔有效注单，其余一律注销。<br />
...
<li>每期极速六合彩开奖球数共七粒(包括特码)。</li>
<li><strong>正码：</strong>当期开出之前6个号码叫正码。每一个号码为一投注组合，假如投注号码为开奖号码之 正码，视为中奖，其馀情形视为不中奖。</li>
