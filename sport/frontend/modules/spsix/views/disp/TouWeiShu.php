<script>
		...
		_lt.init("SPA", "3"); //初始化设定 包括 设定请求ajax 地址
...
<main class="sixMain">
    <input id="lotteryName" type="hidden" value="極速六合彩 头尾数">
    ...
    <?php if($lastOne){?>
        <form name="newForm" id="newForm" action="/?r=spsix/index/six-order" method="post">
                <div  class="p-info p-info2">
                    ...
                    <div class="round-table">
                        <table id="table3" class="tema_a sp-tema_a text-center" style="width:100%"></table>
                    </div>
                    <div class="round-table">
                        <table id="table4" class="tema_a sp-tema_a text-center pb-4" style="width:100%"></table>
                    </div>
                </div>
                <div class="orderbtn">
