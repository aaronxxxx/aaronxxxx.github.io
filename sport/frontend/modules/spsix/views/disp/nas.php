	...
	<main class="sixMain">
		<input id="lotteryName" type="hidden" value="極速六合彩 正码特">
...
function fdch(){
	$.ajax({
        url: "/?r=spsix/index/ajax&rtype=home",
        dataType: 'JSON',
        success: function (res) {
            if (res['isCloseAdmin'] === "true" || res['isCloseNoGame'] === "true") {
				//開盤倒數
				$('.nas_tabinnerArea').html('<div id="isCloseSpan" style="border: 2px red solid;padding: 5px;text-align: center;"> 极速六合彩目前休盘，请等待下一期开盘。</div>');
