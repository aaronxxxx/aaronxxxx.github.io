...
//      });
  ...
  //-->
    ...
    <div class="pdcenter" id="left">
        ...
        <script>
        $.get("/?r=spsix/index/ajax&rtype=home", function(data,hm){
            var result = data;
		...
		<form name="lt_form" id="lt_form" method="post" action="/?r=spsix/ni/mobile-bet-view" onSubmit="return false;" class="Aside">
