<form action="/?r=spsix/sixtop/gold_act" method="get" name="GoldForm" id="GoldForm" style="text-align:center;">
...
<script type="text/javascript">
    ...
    function setGoldSelect(){
        var gold_1 = document.getElementById("gold_1").value;
        var gold_2 = document.getElementById("gold_2").value;
        var gold_3 = document.getElementById("gold_3").value;
        var gold_4 = document.getElementById("gold_4").value;
        if(gold_1<0 ||gold_2<0||gold_3<0||gold_4<0){
            new_alert('金额输入有误!');
            return;
        }
        if(isNaN(gold_1)||isNaN(gold_2)||isNaN(gold_3)||isNaN(gold_4)){
            new_alert('请输入有效金额!');
            return;
        }
        setCookie("gold_1",gold_1,365);
        setCookie("gold_2",gold_2,365);
        setCookie("gold_3",gold_3,365);
        setCookie("gold_4",gold_4,365);
