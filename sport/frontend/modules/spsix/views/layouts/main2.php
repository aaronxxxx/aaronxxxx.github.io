...
<html lang="<?= Yii::$app->language ?>">
    <head>
        ...
        <script src="/public/aomen/js/six/ltOrder_sp.js"></script>
        <script src="/public/aomen/js/six/lt_show_sp.js"></script>
        ...
        <script src="/public/aomen/js/six/spsix.js"></script>
        ...
        <script>
            $(document).ready(function () { 
                ...
                var header = $('header').height(),
                    ...
                    $('main.sixMain').css({'padding-top':header+'px','padding-bottom':footer+btnH+40+'px'},);
