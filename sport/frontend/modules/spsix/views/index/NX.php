            ...
            <div id="left">
                ...
                <div id="left-div">
                    <ul>
                        ...
                        <li class="leftNavItem"> <a href="/?r=spsix/index/index&rtype=NX"><div class="leftNavText leftNavItemActive">合肖</div></a></li>
                    ...
                    <div>
                        <?php if(!empty($lastOne)){?>
                            ...
                            <div id="GrpBtn" style="display:none">
                                ...
                                <!-- 游戏区块 -->
                            <div id="Game">
                                <form name="lt_form" id="lt_form" method="post" action="/?r=spsix/nx/bet-view" onsubmit="return false;">
