    ...
    <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:2px;" bgcolor="#798EB9">
        ...
        foreach($rslist as $key=>$rows){
            ...
            <tr   class="R_tr" align="center" onMouseOver="this.style.backgroundColor='<?=$over?>'" onMouseOut="this.style.backgroundColor='<?=$out?>'" style="background-color:<?=$color?>; line-height:20px;">
                <td height="25" align="center" valign="middle">极速赛车</td>
                <td align="center" valign="middle"><?=$rows['qishu']?></td>
                <td align="center" valign="middle"><?=$rows['datetime']?></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/Ball_3/<?=$rows['ball_1']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/Ball_3/<?=$rows['ball_2']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/Ball_3/<?=$rows['ball_3']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/Ball_3/<?=$rows['ball_4']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/Ball_3/<?=$rows['ball_5']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/Ball_3/<?=$rows['ball_6']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/Ball_3/<?=$rows['ball_7']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/Ball_3/<?=$rows['ball_8']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/Ball_3/<?=$rows['ball_9']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/Ball_3/<?=$rows['ball_10']?>.png"></td>
                <?php
