    ...
    <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:2px;" bgcolor="#798EB9">
        ...
        foreach($rslist as $key=>$rows){
            ...
            <tr   class="R_tr" align="center" onMouseOver="this.style.backgroundColor='<?=$over?>'" onMouseOut="this.style.backgroundColor='<?=$out?>'" style="background-color:<?=$color?>; line-height:20px;">
                ...
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/ball_5/<?=$rows['ball_1']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/ball_5/<?=$rows['ball_2']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/ball_5/<?=$rows['ball_3']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/ball_5/<?=$rows['ball_4']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/ball_5/<?=$rows['ball_5']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/ball_5/<?=$rows['ball_6']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/ball_5/<?=$rows['ball_7']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/ball_5/<?=$rows['ball_8']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/ball_5/<?=$rows['ball_9']?>.png"></td>
                <td align="center" valign="middle"><img src="<?=$imgUrl?>/ball_5/<?=$rows['ball_10']?>.png"></td>
                <?php
                    if($ballutil->Pk10_Auto_quick($hm,1)==11){
                ?>
                    <td><?=$ballutil->Pk10_Auto_quick($hm,1)?> / <span>和</span> / <span>和</span> </td>
                <?php
                }else{
                ?>
                    <td><?=$ballutil->Pk10_Auto_quick($hm,1)?> / <?=($ballutil->Pk10_Auto_quick($hm,2)=="大"?"<span style=\"color: red;\">".$ballutil->Pk10_Auto_quick($hm,2)."</span>":$ballutil->Pk10_Auto_quick($hm,2))?> / <?=($ballutil->Pk10_Auto_quick($hm,3)=="双"?"<span style=\"color: red;\">".$ballutil->Pk10_Auto_quick($hm,3)."</span>":$ballutil->Pk10_Auto_quick($hm,3))?></td>
                <?php
                    }
                ?>
                    <td><?=($ballutil->Pk10_Auto_quick($hm,4)=="龙"?"<span style=\"color: red;\">".$ballutil->Pk10_Auto_quick($hm,4)."</span>":$ballutil->Pk10_Auto_quick($hm,4))?> / <?=($ballutil->Pk10_Auto_quick($hm,5)=="龙"?"<span style=\"color: red;\">".$ballutil->Pk10_Auto_quick($hm,5)."</span>":$ballutil->Pk10_Auto_quick($hm,5))?> / <?=($ballutil->Pk10_Auto_quick($hm,6)=="龙"?"<span style=\"color: red;\">".$ballutil->Pk10_Auto_quick($hm,6)."</span>":$ballutil->Pk10_Auto_quick($hm,6))?> / <?=($ballutil->Pk10_Auto_quick($hm,7)=="龙"?"<span style=\"color: red;\">".$ballutil->Pk10_Auto_quick($hm,7)."</span>":$ballutil->Pk10_Auto_quick($hm,7))?> / <?=($ballutil->Pk10_Auto_quick($hm,8)=="龙"?"<span style=\"color: red;\">".$ballutil->Pk10_Auto_quick($hm,8)."</span>":$ballutil->Pk10_Auto_quick($hm,8))?></td>
                </tr>
        <?php
        }
        if($hasRow=="false"){
