...
namespace app\modules\lottery\modules\lzpk10\models\ar;
 ...
 */
class LotteryResultBjpk extends \yii\db\ActiveRecord
{
	public static function getKJResult()
	{
        $lastResult = "select * from lottery_result_bjpk where datetime <= NOW() order by datetime desc limit 1";
