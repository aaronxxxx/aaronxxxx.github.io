...
namespace app\modules\lottery\modules\lztjsf\models\ar;
 ...
 */
class LotteryResultTjsf extends \yii\db\ActiveRecord
{
	public static function getKJResult()
	{
        $lastResult = "select * from lottery_result_tjsf where datetime <= NOW() order by datetime desc limit 1";
