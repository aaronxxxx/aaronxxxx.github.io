<script src="/public/luzhu/js/tjklsf.js"></script>
<div id="html_content">
            ...
            <div id="side_left" class="side_left">
                <div id="leftSwapBtn">
                    <ul>
                        ...
                        <li class="zuijin" onclick="openUCWindow('/?r=member/lottery/lottery-one&time=<?=date('Y/m/d')?>&type=TJSF', '交易记录')">最近交易记录</li>
                    </ul>
                </div>
                    ...
                    <div class="bet-results-box allline">
                        <ul class="tbpadding" id="topul">
                            <li class="rline l column-9">
                                <h3 style="padding-left:70px;">天津快乐十分</h3>
                            </li>
                        ...
                        <div class="zhongleitab">
                            <div class="klctouzhuArea">
                                ...
                                <table class="struct_table ballno-tab touzhuArea w100 t1 danqiuct" style="display: block;">
                                    <tr>
                                        <?php
                                        $BallSecondToEight = ['第一球','第二球','第三球','第四球','第五球','第六球','第七球','第八球'];
                                        foreach($BallSecondToEight as $key => $val) {
                                        if($key==4){
                                        ?>
                                    </tr>
                                </table>
                                    ...
                                    <table class="struct_table ballno-tab touzhuArea w100 t1">
                                        ...
                                        <tr class="bet-item">
                                            ...
                                            <td class="amount ball_<?=$b?>_t<?=$BallKey+21?>" width="40%">
                                                <input name="ball_<?=$b?>_<?=$BallKey+21?>" class="ball_<?=$b?>_<?=$BallKey+21?> amount-input" style="border: 1px solid #B0B0B0; background-color: transparent" type="text" onkeyup="digitOnly(this)" maxlength="5"></td>
                                        </tr>
