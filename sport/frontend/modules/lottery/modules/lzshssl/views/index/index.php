<script src="/public/luzhu/js/shssl.js"></script>
<div id="html_content">
    <div id="layout" class="container">
        ...
        <div class="sidebar">
            ...
            <div id="side_left" class="side_left">
                <div id="leftSwapBtn">
                    <ul>
                        <li class="jiaoyis" onclick="openUCWindow('/?r=member/lottery/lottery-one&time=<?=date('Y/m/d')?>&type=T3', '交易记录')">最近交易记录</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div id="html_ctx">
                        <div class="betAreaBox ssc">
                            <div class="bet-results-box allline">
                                <ul class="tbpadding" id="topul">
                                    <li class="rline l column-9">
                                        <h3 style="padding-left:70px;">上海时时乐</h3>
                                    </li>
                                ...
                                <ul id="Ul1">
                                    <li class="rline l column-9">
                                        <h3><strong class="green" id="currGameNo"></strong>&nbsp;期&nbsp;
                                            <strong class="lan" id="panname">两面盘</strong>
                                        </h3>
                                    </li>
                            ...
                            <div id="html_area">
                                ...
                                <div class="zhongleitab">
                                    <?php
                                    $OneToThree = ['第一球','第二球','第三球'];
                                    foreach($OneToThree as $one => $val6) {
                                        ?>
                                        <div class="ssctouzhuArea">
                                            <table style="display: table;" class="t1 w100 bettable ball_sc_1 ball_sc touzhuArea">
                                                <tbody>
                                                        ...
                                                        if($title==0||$title==3||$title==6||$title==9||$title==12) {
                                                            ...
                                                            <tr class="bet-item">
                                                                <?php if($title<10) { ?>
                                                                    ...
                                                                    <?php }else { ?>
                                                                    <td class="fontBlue" width="30%"><?=$val7?></td>
                                                                    <?php } ?>
                                                                ...
                                                                <td class="amount ball_<?=$one+1?>_t<?=$title+1?>" width="40%">
                                                                    <input name="ball_<?=$one+1?>_<?=$title+1?>" class="ball_<?=$one+1?>_<?=$title+1?> amount-input" style="border: 1px solid #B0B0B0; background-color: transparent" type="text" onkeyup="digitOnly(this)" maxlength="5"></td>
                                                            </tr>
