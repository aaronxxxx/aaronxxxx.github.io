...
namespace app\modules\lottery\modules\lzkl8\models\ar;
 ...
 */
class LotteryResultBjkn extends \yii\db\ActiveRecord
{
	public static function getKJResult()
	{
        $lastResult = "select * from lottery_result_bjkn where datetime <= NOW() order by datetime desc limit 1";
