...
namespace app\modules\lottery\modules\lzgdsf\models\ar;
 ...
 */
class LotteryResultGdsf extends \yii\db\ActiveRecord
{
	public static function getKJResult()
	{
        $lastResult = "select * from lottery_result_gdsf where datetime <= NOW() order by datetime desc limit 1";
