<script src="/public/luzhu/js/tjssc.js"></script>
<div id="html_content">
			...
			<div id="side_left" class="side_left">
				<div id="leftSwapBtn">
					<ul>
						...
						<li class="zuijin" onclick="openUCWindow('/?r=member/lottery/lottery-one&time=<?=date('Y/m/d')?>&type=TJ', '交易记录')">最近交易记录</li>
					</ul>
				</div>
					...
					<div id="html_ctx">
						<div class="betAreaBox ssc">
							<div class="bet-results-box allline">
								<ul class="tbpadding" id="topul">
									<li class="rline l column-9">
										<h3 style="padding-left:70px;">极速时时彩</h3>
									</li>
								...
								<ul id="Ul1">
									...
									<li>
                                        <span class="ml10">
                                            距离封盘： <b class="red" id="freezeTime">00:00</b>
                                        </span>
										<span class="ml10">
                                            距离开奖： <b class="red" id="dealingTime">00:00</b>
                                        </span>
									</li>
								</ul>
							</div>
							<div id="html_area">
									...
									<div class="common betArea touzhuArea">
										<div class="ssctouzhuArea">
											<table style="display: table;" class="t1 w100 bettable ball_sc_1 ball_sc touzhuArea">
												...
												<tr>
													<?php
													$Danqiu = ['第一球','第二球','第三球','第四球','第五球'];
													foreach($Danqiu as $dq => $val5){
														?>
								...
								<!--第一球 - 第五球-->
								<?php
								$OneToFive = ['第一球','第二球','第三球','第四球','第五球'];
								foreach ($OneToFive as $key => $val){
									?>
									<div class="zhongleitab">
										<div class="ssctouzhuArea">
											<table style="display: table;" class="t1 w100 bettable ball_sc_1 ball_sc touzhuArea">
												<tr>
													...
													foreach($ball_title as $title => $val1) {
														if($title==0||$title==3||$title==6||$title==9||$title==12) {
															...
															<tr class="bet-item">
																<?php if($title<10) { ?>
																	<td class="fontBlue" width="30%"><span
																			class="number num<?= $title ?>"></span>
																	</td>
																	<?php }else { ?>
																	<td class="fontBlue" width="30%"><?=$val1?></td>
																	<?php } ?>
												...
												<table style="width: 100%;">
													<tr class="bet-item">
														...
														<td class="amount ball_10_t<?=$key5+1?>">
															<input name="ball_10_<?=$key5+1?>" class="ball_10_<?=$key5+1?> amount-input" style="border: 1px solid #B0B0B0; background-color: transparent" type="text" onkeyup="digitOnly(this)" maxlength="5">
														</td>
													</tr>
												</table>
											</td>
