<script src="/public/luzhu/js/cqklsf.js"></script>
<div id="html_content">
            ...
            <div id="side_left" class="side_left">
                <div id="leftSwapBtn">
                    <ul>
                        ...
                        <li class="zuijin" onclick="openUCWindow('/?r=member/lottery/lottery-one&time=<?=date('Y/m/d')?>&type=CQSF', '交易记录')">最近交易记录</li>
                    </ul>
                </div>
                    ...
                    <div class="bet-results-box allline">
                        <ul class="tbpadding" id="topul">
                            <li class="rline l column-9">
                                <h3 style="padding-left:70px;">重庆快乐十分</h3>
                            </li>
                            ...
                            <div class="klctouzhuArea">
                                <table class="w100 touzhuArea t1">
                                    ...
                                    <tr>
                                        ...
                                        <?php } ?>
                                            <tr class="bet-item">
                                                <td class="fontBlue td_cmn"><?=$zval?></td>
