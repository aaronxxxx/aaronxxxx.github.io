<script src="/public/luzhu/js/ssrc.js"></script>
<div id="html_content">
            ...
            <div id="side_left" class="side_left">
                <div id="leftSwapBtn">
                    <ul>
                        ...
                        <li class="zuijin" onclick="openUCWindow('/?r=member/lottery/lottery-one&time=<?=date('Y/m/d')?>&type=SSRC', '交易记录')">最近交易记录</li>
                    </ul>
                </div>
                            ...
                            <div class="bet-results-box allline">
                                <ul class="tbpadding" id="topul">
                                    <li class="rline l column-9">
                                        <h3 style="padding-left:70px;">极速赛车(SSRC)</h3>
                                    </li>
