<script src="/public/luzhu/js/pl3.js"></script>
<div id="html_content">
    <div id="layout" class="container">
        ...
        <div class="sidebar">
            ...
            <div id="side_left" class="side_left">
                <div id="leftSwapBtn">
                    <ul>
                        <li class="jiaoyis" onclick="openUCWindow('/?r=member/lottery/lottery-one&time=<?=date('Y/m/d')?>&type=P3', '交易记录')">最近交易记录</li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="bet-results-box allline">
                                <ul class="tbpadding" id="topul">
                                    <li class="rline l column-9">
                                        <h3 style="padding-left:70px;">排列3</h3>
                                    </li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%" style="border: 0px;">
                                                        ...
                                                        <tr class="bet-item">
                                                            ...
                                                            <td style="color: red;" class="td_cmn bet_odds ball_<?=$one+1?>_h1" width="30%"><?=$oddslist['ball'][$one+1][$title+1]?></td>
