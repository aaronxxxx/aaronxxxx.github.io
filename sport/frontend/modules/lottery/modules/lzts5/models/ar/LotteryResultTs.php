...
namespace app\modules\lottery\modules\lzts5\models\ar;
 ...
 */
class LotteryResultTs extends \yii\db\ActiveRecord
{
	public static function getKJResult()
	{
        $lastResult = "select * from lottery_result_ts where datetime <= NOW() order by datetime desc limit 1";
