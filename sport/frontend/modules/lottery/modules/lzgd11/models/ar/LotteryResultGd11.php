...
namespace app\modules\lottery\modules\lzgd11\models\ar;
 ...
 */
class LotteryResultGd11 extends \yii\db\ActiveRecord
{
	public static function getKJResult()
	{
        $lastResult = "select * from lottery_result_gd11 where datetime <= NOW() order by datetime desc limit 1";
