...
namespace app\modules\lottery\modules\lzorpk\models\ar;
 ...
 */
class LotteryResultOrpk extends \yii\db\ActiveRecord
{
	public static function getKJResult()
	{
        $lastResult = "select * from lottery_result_orpk where datetime <= NOW() order by datetime desc limit 1";
