...
namespace app\modules\lottery\modules\lzfc3d\models\ar;
 ...
 */
class LotteryResultD3 extends \yii\db\ActiveRecord
{
	public static function getKJResult()
	{
        $lastResult = "select * from lottery_result_d3 where datetime <= NOW() order by datetime desc limit 1";
