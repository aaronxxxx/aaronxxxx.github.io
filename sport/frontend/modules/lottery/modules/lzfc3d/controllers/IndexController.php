<?php
namespace app\modules\lottery\modules\lzfc3d\controllers;
...
class IndexController extends BaseController {
	const CONST_LOTTERY_TYPE='D3';
	const CONST_LOTTERY_NAME='3D彩';
	...
	public function actionIndex() {
        $Lottery_set = WebClose::getWebClose('d3');
        $result = LotteryResultD3::getKJResult();
     ...
     * */
    public static function getFc3dInfo(){
        ...
        $KJResult=LotteryResultD3::getKJResult();
        if ($KJResult){
    ...
    try {
		...
		$orderlottery->rtype_str='快速-3D彩';
		$orderlottery->rtype='745';
		...
		for($i = 0; $i < count ( $data ); $i ++) {
          ...
          error_log('IndexController.insert：'.$e->getTraceAsString().'online:'.$e->getLine().'，type：lzfc3d，time:'.date('Y-m-d h:i:s',time()).''."\r\n", 3, "error.log");
    ...
    public function GetScheduleInfo() {
        ...
        $jiaodui = WebClose::getWebClose('fc_jiaod');
