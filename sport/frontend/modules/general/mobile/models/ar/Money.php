...
class Money extends ActiveRecord{
     ...
     */
    static public function addMoenyNews($uid,$order_amount,$order_no,$assets) {
        $money = new Money;
        $money->user_id          = $uid;
        ...
        $r = $money->id;
        return $r; 
        //$sql ="insert into money(user_id,order_value,order_num,status,assets,balance) values($uid,$order_amount, $order_no,'确认', $assets, $assets+$order_amount)";
        //$result = yii::$app->db->createCommand($sql)->query();
        //return $result;  
    }
    
    static public function updateMoneyNews($m_id) {
