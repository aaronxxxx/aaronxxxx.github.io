...
class LotteryController extends BaseController {
    ...
    public function actionLottery() {
        ...
        $arr1['sum'] = $arr1['lhc'] + $arr1['splhc'] + $arr1['d3'] + $arr1['p3'] + $arr1['t3'] + $arr1['cq'] + $arr1['jx'] + $arr1['tj'] + $arr1['gxsf'] + $arr1['gdsf'] + $arr1['tjsf'] + $arr1['gd11'] + $arr1['bjpk'] + $arr1['bjkn'] + $arr1['cqsf'] + $arr1['mlaft'] + $arr1['ssrc'] + $arr1['ts'] + $arr1['orpk'];
        ...
        $arr3['ts'] = $ts_win;
        $arr3['orpk'] = $orpk_win;
        $arr3['sum'] = $arr3['lhc']+ $arr3['splhc'] + $arr3['d3'] + $arr3['p3'] + $arr3['t3'] + $arr3['cq'] + $arr3['jx'] + $arr3['tj'] + $arr3['gxsf'] + $arr3['gdsf'] + $arr3['tjsf'] + $arr3['gd11'] + $arr3['bjpk'] + $arr3['bjkn'] + $arr3['cqsf'] + $arr3['ssrc'] + $arr3['mlaft'] + $arr3['ts'] + $arr3['orpk'];
     ...
     */
     public function actionLotterySplhc(){
        ...
        return $this->render('lotterySpLhc', ['arr1' => $arr1, 'arr2' => $arr2,'pages'=>$pages]);
    }
    /**
     * 返回彩票历史记录（前6天）
     * @return type
