<main>
    <input id="lotteryName" type="hidden" name="" value="腾讯分分彩">
    <ul class="label pl-4 pr-4 pt-4 pb-2">
        ...
        <li class="d-flex justify-content-between align-items-center pb-3">
            <input class="lotteryResultBtn" type="button" value="开奖记录"  onclick="javascript:location.href='/index.php?r=mobile/lottery/lottery-result/index&gtype=TS'">
...
<script type="text/javascript" src="/public/aomen/lottery/js/ts5.js"></script>