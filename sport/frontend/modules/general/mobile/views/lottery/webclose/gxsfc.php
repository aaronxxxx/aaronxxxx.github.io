<main>
    <input id="lotteryName" type="hidden" name="" value="广西十分彩">
    <ul class="label pl-4 pr-4 pt-4 pb-2">
        ...
        <li class="d-flex justify-content-between align-items-center pb-3">
            <input class="lotteryResultBtn" type="button" value="开奖记录"  onclick="javascript:location.href='/index.php?r=mobile/lottery/lottery-result/index&gtype=GXSF'">
        ...
        <form name="orders">
            <section class="tabArea  pl-4 pr-4 pb-2">
                ...
                <ul id="tab" class="tab d-flex flex-wrap justify-content-between">
                    <li class="item item4 mb-2 act"><a data-href="#total"><div class="itemInner">总和 龙虎和</div></a></li>
                    <li class="item item4 mb-2"><a data-href="#f3"><div class="itemInner">前三球</div> </a></li>
                    <li class="item item4 mb-2"><a data-href="#m3"><div class="itemInner">中三球</div> </a></li>
                    <li class="item item4 mb-2"><a data-href="#b3"><div class="itemInner">后三球</div> </a></li>
            ...
            <div id="tabinnerBet" class="tabinnerArea  pl-4 pr-4">
                ...
                <div id="f3" class="tabinner">
                    ...
                    <ul>
                        <?php 
                            ...
                            $a = count($arr);
                            for ( $i=0 ; $i<$a ; $i++ ) { ?> 
                                <li><span class="bian_td_lab"><?= $arr[$i]?> </span><span class="bian_td_odds" id="ball_7_h<?= $arr2[$i] ?>"><?=$oddslists['ball'][7][$arr2[$i]]?></span><span class="bian_td_inp" id="ball_7_t<?=$arr2[$i] ?>">
                                    <input name="ball_7_<?=$arr2[$i] ?>" id="ball_7_<?=$arr2[$i] ?>" class="inp1" onkeyup="digitOnly(this)" onfocus="this.className='inp1m'" onblur="this.className='inp1';" type="text" maxlength="5">
                                </span></li>
                        <?php }?>
                    </ul>
                </div>
                <div id="m3" class="tabinner">
                    ...
                    <ul>
                        <?php 
                            ...
                            $a = count($arr);
                            for ( $i=0 ; $i<$a ; $i++ ) { ?> 
                                <li><span class="bian_td_lab"><?= $arr[$i]?> </span><span class="bian_td_odds" id="ball_8_h<?= $arr2[$i] ?>"><?=$oddslists['ball'][8][$arr2[$i]]?></span><span class="bian_td_inp" id="ball_8_t<?=$arr2[$i] ?>">
                                    <input name="ball_8_<?=$arr2[$i] ?>" id="ball_8_<?=$arr2[$i] ?>" class="inp1" onkeyup="digitOnly(this)" onfocus="this.className='inp1m'" onblur="this.className='inp1';" type="text" maxlength="5">
                                </span></li>
                        <?php }?>
                    </ul>
                </div>
                <div id="b3" class="tabinner">
                    ...
                    <?php 
                            ...
                            $a = count($arr);
                            for ( $i=0 ; $i<$a ; $i++ ) { ?> 
                                <li><span class="bian_td_lab"><?= $arr[$i]?> </span><span class="bian_td_odds" id="ball_9_h<?= $arr2[$i] ?>"><?=$oddslists['ball'][9][$arr2[$i]]?></span><span class="bian_td_inp" id="ball_9_t<?=$arr2[$i] ?>">
                                    <input name="ball_9_<?=$arr2[$i] ?>" id="ball_9_<?=$arr2[$i] ?>" class="inp1" onkeyup="digitOnly(this)" onfocus="this.className='inp1m'" onblur="this.className='inp1';" type="text" maxlength="5">
                                </span></li>
                        <?php }?>
                    </ul>
                </div>
...
<script type="text/javascript" src="/public/aomen/lottery/js/gxsf.js"></script>
