<main>
    ...
    <ul class="label pl-4 pr-4 pt-4 pb-2">
        ...
        <li class="d-flex justify-content-between align-items-center pb-3">
            <input class="lotteryResultBtn" type="button" value="开奖记录"  onclick="javascript:location.href='/index.php?r=mobile/lottery/lottery-result/index&gtype=GD11'">
        ...
        <form name="orders">
            <section class="tabArea  pl-4 pr-4 pb-2">
                ...
                <ul id="tab" class="tab d-flex flex-wrap justify-content-between">
                    <li class="item mb-2 item4 act "><a data-href="#total"><div class="itemInner">总和 龙虎和</div></a></li>
                    <li class="item mb-2 item4"><a data-href="#f3"><div class="itemInner">前三球</div> </a></li>
                    <li class="item mb-2 item4"><a data-href="#m3"><div class="itemInner">中三球</div> </a></li>
                    <li class="item mb-2 item4"><a data-href="#b3"><div class="itemInner">后三球</div> </a></li>
