    ...
    <div class="charge report">
        ...
        <div class="datepicker">
            <ul id="" class="d-flex justify-content-between fastDate mb-3">
                <li class="item">
                    <a href="/?r=mobile/lottery/lottery-lhc&time=<?= date('Y-m-d',strtotime('-0 day'))?>&type=LT">
                        <p>今日</p>
                    </a>
                </li>
                <li class="item">
                    <a href="/?r=mobile/lottery/lottery-lhc&time=<?= date('Y-m-d',strtotime('-1 day'))?>&type=LT">
                        <p>昨日</p>
                    </a>
                </li>
                <!-- <li class="item">
