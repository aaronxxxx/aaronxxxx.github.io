    ...
    <div class="content pb-2 ">
        <section class="tabArea pt-4 pl-4 pr-4 pb-2">
            <ul id="tab" class="tab d-flex flex-wrap justify-content-center">
                ...
                <li class="item mb-2"><a id="so2" onclick="result_type_select(this);"><div class="itemInner">奇偶</div> </a></li>
                <li class="item mb-2"><a id="ud" onclick="result_type_select(this);"><div class="itemInner">上下</div> </a></li> -->
            ...
            <tbody>
                <tr>
                    ...
                    <td class="d-flex flex-wrap sub_number" name='sub_number'>
                        <span class="mb-1 ballc_<?=$rows['ball_1']?>"><?=$rows['ball_1']?></span>
                        <span class="mb-1 ballc_<?=$rows['ball_2']?>"><?=$rows['ball_2']?></span>
                        <span class="mb-1 ballc_<?=$rows['ball_3']?>"><?=$rows['ball_3']?></span>
                        <span class="mb-1 ballc_<?=$rows['ball_4']?>"><?=$rows['ball_4']?></span>
                        <span class="mb-1 ballc_<?=$rows['ball_5']?>"><?=$rows['ball_5']?></span>
                        <span class="mb-1 ballc_<?=$rows['ball_6']?>"><?=$rows['ball_6']?></span>
                        <span class="mb-1 ballc_<?=$rows['ball_7']?>"><?=$rows['ball_7']?></span>
                        <span class="mb-1 ballc_<?=$rows['ball_8']?>"><?=$rows['ball_8']?></span>
                        <span class="mb-1 ballc_<?=$rows['ball_9']?>"><?=$rows['ball_9']?></span>
                        <span class="mb-1 ballc_<?=$rows['ball_10']?>"><?=$rows['ball_10']?></span>
                        <span class="mb-1 ballc_<?=$rows['ball_11']?>"><?=$rows['ball_11']?></span>
                        <span class="mb-1 ballc_<?=$rows['ball_12']?>"><?=$rows['ball_12']?></span>
                        <span class="mb-1 ballc_<?=$rows['ball_13']?>"><?=$rows['ball_13']?></span>
                        <span class="mb-1 ballc_<?=$rows['ball_14']?>"><?=$rows['ball_14']?></span>
                        <span class="mb-1 ballc_<?=$rows['ball_15']?>"><?=$rows['ball_15']?></span>
                        <span class="mb-1 ballc_<?=$rows['ball_16']?>"><?=$rows['ball_16']?></span>
                        <span class="ballc_<?=$rows['ball_17']?>"><?=$rows['ball_17']?></span>
                        <span class="ballc_<?=$rows['ball_18']?>"><?=$rows['ball_18']?></span>
                        <span class="ballc_<?=$rows['ball_19']?>"><?=$rows['ball_19']?></span>
                        <span class="ballc_<?=$rows['ball_20']?>"><?=$rows['ball_20']?></span>
                    </td>
                    ...
                    <td class="sub_number" name='sub_sum'>
                        <?=($ballutil->Kl8_convert($ballutil->Kl8_Auto($hm,2))=="总和大"?"<span style=\"color: red;\">".$ballutil->Kl8_convert($ballutil->Kl8_Auto($hm,2))."</span>":$ballutil->Kl8_convert($ballutil->Kl8_Auto($hm,2)))?>                        
                        <?=($ballutil->Kl8_convert($ballutil->Kl8_Auto($hm,3))=="总和双"?"<span style=\"color: red;\">".$ballutil->Kl8_convert($ballutil->Kl8_Auto($hm,3))."</span>":$ballutil->Kl8_convert($ballutil->Kl8_Auto($hm,3)))?>                        
                        <?=$ballutil->Kl8_convert($ballutil->Kl8_Auto($hm,5))?>
                        <?=$ballutil->Kl8_convert($ballutil->Kl8_Auto($hm,4))?>
                        <?=$ballutil->Kl8_Auto($hm,1)?>
                    </td>
                </tr>
            </tbody>
                <?php }?>
