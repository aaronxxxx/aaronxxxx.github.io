...
?>
<main>
    <input id="lotteryName" type="hidden" name="" value="老pk拾">
    ...
    <div class="iframe-wrapper" style="pointer-events: none; opacity: 0; top: -300px;">
        <div class="iframe-wrapper-header">
            <div class="heading2">老PK拾 开奖视频</div>
            <div class="btn">
                <button id="close_kj_video" class="btn-no_style">关闭</button>
            </div>
        </div>
        <!-- <iframe src="/public/lottery_result/orpk/kj_video.html"></iframe> -->
        <iframe src="/public/video/orpk/index.html"></iframe>
    </div>
    <script>
        $(function () {
            // 視頻標題
...
<script type="text/javascript" src="/public/aomen/lottery/js/orpk.js"></script>
