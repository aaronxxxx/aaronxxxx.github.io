            ...
            <tbody>
                <tr>
                    ...
                    <td class="sub_number" name='sub_sum'>
                        <?=$ballutil->gxsf_Auto($hm,1)?> / <?=($ballutil->gxsf_Auto($hm,2)=="总和大"?"<span style=\"color: red;\">".$ballutil->gxsf_Auto($hm,2)."</span>":$ballutil->gxsf_Auto($hm,2))?> / <?=($ballutil->gxsf_Auto($hm,3)=="总和双"?"<span style=\"color: red;\">".$ballutil->gxsf_Auto($hm,3)."</span>":$ballutil->gxsf_Auto($hm,3))?> / <?=($ballutil->gxsf_Auto($hm,4)=="龙"?"<span style=\"color: red;\">".$ballutil->gxsf_Auto($hm,4)."</span>":$ballutil->gxsf_Auto($hm,4))?>
                    </td>
                    <td class="sub_number" name='sub_so2'>
                        <?=$ballutil->gxsf_Auto($hm,5)?> / <?=$ballutil->gxsf_Auto($hm,6)?> / <?=$ballutil->gxsf_Auto($hm,7)?>
                    </td>
                </tr>
            </tbody>
                <?php }?>
