...
<html lang="<?= Yii::$app->language ?>">
    <head>
        ...
        <link href="/public/aomen/lottery/css/fast-bet.css" rel="stylesheet"/>
        <script src="/public/aomen/lottery/js/jquery-1.11.1.min.js"></script>
        <script src="/public/layer/layer.js"></script>
        <script src="/public/aomen/lottery/js/swiper.jquery.min.js"></script>
        <script src="/public/aomen/lottery/js/base.js"></script>
        <script src="<?= Yii::getAlias('@themeRoot') ?>/assets/js/http.js"></script>
        <script src="/public/aomen/lottery/js/fast-bet.js"></script>
    ...
    <body>
        ...
        $(document).ready(function () { 
            ...
            var header = $('header').height(),
                      ...
                      btnH = $('.btns').height();
                      console.log(header+'/'+footer+'/'+btnH);
                $('main').css({'padding-top':header+8,'padding-bottom':footer+(btnH*1.5)});
